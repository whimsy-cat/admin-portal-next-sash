...
function changePrimaryColor(input) {
  ...
  SwitcherData.dynamicTransparentPrimaryColor(dynamicBackgroundColor, input);
...
function TransparentBackground(input) {
  ...
  SwitcherData.dynamicBgTransparentBackground(dynamicBackgroundColor, input);
                    ...
                    <div className="skin-body">
                      <div className="switch_section">
                        ...
                        <div className="switch-toggle d-flex">
                          ...
                          <div className="">
                            <input
                              className="w-30p h-30 input-color-picker color-primary-light"
                              onChange={(ele) => {
                    ...
                    <div className="skin-body">
                      <div className="switch_section">
                        ...
                        <div className="switch-toggle d-flex mt-2">
                          ...
                          <div className="">
                            <input
                              className="w-30p h-30 input-dark-color-picker color-primary-dark"
                  ...
                  <div className="swichermainleft">
                    ...
                    <div className="skin-body switch_section">
                      <div className="switch-toggle d-flex">
                        ...
                        <div className="">
                          <input
                            className="w-30p h-30 color-primary-img-transparent"
                            defaultValue="#6c5ffc"
                            id="transparentBgImgPrimaryColorID"
                            onChange={(ele) => {
                              BgImgTransparentPrimaryColor(ele.target.value);
                            }}
                            type="color"
                            data-id="bg-color"
                            data-id1="bg-hover"
                          ...
                          <img
                            src={`${url}${
                              process.env.NODE_ENV === "production"
                                ? "/sash/preview/"
                                : "/"
                            }assets/images/media/bg-img4.jpg`}
                            alt="Bg-4"
                            id="bgimage4"
                          />
                        </Link>
