                        ...
                        <div className="row mb-4">
                          ...
                          <div className="col-sm-10 ps-sm-0">
                            <div className="d-flex align-items-end justify-content-between ms-2">
                              ...
                              <div>
                                <Link href="#"><i className="fe fe-settings me-1"></i></Link>
                                <Link href="#"><i className="fe fe-x"></i></Link>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-2'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/sash/preview/' : "/"}assets/images/users/2.jpg`} />
                        </div>
                        <div className="">
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-11'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/sash/preview/' : "/"}assets/images/users/11.jpg`} />
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-10'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/sash/preview/' : "/"}assets/images/users/10.jpg`} />
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                            <div className="fw-semibold text-dark" data-bs-toggle="modal"
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-13'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/sash/preview/' : "/"}assets/images/users/13.jpg`} />
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                            <div className="fw-semibold text-dark" data-bs-toggle="modal"
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-12'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/sash/preview/' : "/"}assets/images/users/12.jpg`} />
                          <span className="avatar-status bg-success"></span>
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-15'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/sash/preview/' : "/"}assets/images/users/15.jpg`} />
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                            <div className="fw-semibold text-dark" data-bs-toggle="modal"
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-4'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/sash/preview/' : "/"}assets/images/users/4.jpg`} />
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                            <div className="fw-semibold text-dark" data-bs-toggle="modal"
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-7'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/sash/preview/' : "/"}assets/images/users/7.jpg`} />
                          <span className="avatar-status bg-success"></span>
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-9'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/sash/preview/' : "/"}assets/images/users/9.jpg`} />
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                            <div className="fw-semibold text-dark" data-bs-toggle="modal"
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-14'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/sash/preview/' : "/"}assets/images/users/14.jpg`} />
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                            <div className="fw-semibold text-dark" data-bs-toggle="modal"
