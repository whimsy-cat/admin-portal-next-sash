      ...
      <Row className="row-sm">
        <Col md={5} lg={5} xl={3}>
              ...
              <ListGroup className="list-group-transparent mb-0 file-manager">
                <div className="d-flex">
                  <div>
                    ...
                    >
                      <i className="fe fe-image fs-18 me-2 text-success p-2"></i>
                      Images
                    </Link>
                  </div>
                ...
                <div className="d-flex">
                  <div>
                    <Link
                      ...
                      className="list-group-item  d-flex align-items-center px-0"
                    >
                      <i className="fe fe-video fs-18 me-2 text-secondary p-2"></i>
                      Videos
                    </Link>
                  </div>
                  <div className="text-end ms-auto mt-3">
          ...
          <Card>
            <Card.Body>
              <div className="d-flex">
                <Link href="#" className="file-manager-image">
                  <img
                    src={"../../../assets/images/media/files/documents/11.png"}
                    alt="img"
                  />
                </Link>
                ...
                <div className="ms-5 ms-auto">
                  <Dropdown>
                    <Dropdown.Toggle as="a" className="text-muted no-caret">
              ...
              <div className="">
                <div className="d-flex">
                  ...
                  <div className="ms-auto my-auto">
                    <h6 className="mt-2">
                      <i className="fe fe-circle text-danger fs-12"></i> Used
                    </h6>
          ...
          <Row className="row-sm">
            ...
            <Col xl={3} md={6} sm={6}>
              <Card className="pos-relative">
                <Link
                  href={`/components/filemanager/file-manager-list`}
                  className="open-file"
                ></Link>
                <Card.Body className="px-4 pt-4 pb-2">
                  <div className="d-flex">
                    ...
                    <Dropdown className="ms-auto mt-1">
                      ...
                      <Dropdown.Menu>
                        <Dropdown.Item>
                          <i className="fe fe-edit mx-1"></i> Edit
                        </Dropdown.Item>
                        <Dropdown.Item>
                          <i className="fe fe-share mx-1"></i> Share
                        </Dropdown.Item>
                        <Dropdown.Item>
                          <i className="fe fe-download mx-1"></i> Download
                        </Dropdown.Item>
                        <Dropdown.Item>
                          <i className="fe fe-trash mx-1"></i> Delete
                        </Dropdown.Item>
                      </Dropdown.Menu>
                    </Dropdown>
                  </div>
          ...
          <Row className="row-sm">
            <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
              <Card className="overflow-hidden">
                ...
                >
                  <img
                    src={"../../../assets/images/media/files/documents/6.png"}
                    alt="img"
                  />
                </Link>
                <Card.Footer>
            ...
            <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
              <Card className="overflow-hidden">
                <Link href={`/components/filemanager/file-details/`}>
                  <img
                    src={"../../../assets/images/media/files/07.jpg"}
                    alt="img"
            ...
            <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
              <Card className="overflow-hidden">
                ...
                >
                  <img
                    src={"../../../assets/images/media/files/documents/2.png"}
                    alt="img"
                  />
                </Link>
                <Card.Footer>
            ...
            <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
              <Card className="overflow-hidden">
                ...
                >
                  <img
                    src={"../../../assets/images/media/files/documents/7.png"}
                    alt="img"
                  />
                </Link>
                <Card.Footer>
            ...
            <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
              <Card className="overflow-hidden">
                ...
                >
                  <img
                    src={"../../../assets/images/media/files/documents/10.png"}
                    alt="img"
                  />
                </Link>
                <Card.Footer>
            ...
            <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
              <Card className="overflow-hidden">
                ...
                >
                  <img
                    src={"../../../assets/images/media/files/documents/8.png"}
                    alt="img"
                  />
                </Link>
                <Card.Footer>
            ...
            <Col xl={4} xxl={3} lg={6} md={6} sm={6}>
              <Card className="overflow-hidden">
                ...
                >
                  <img
                    src={"../../../assets/images/media/files/documents/9.png"}
                    alt="img"
                  />
                </Link>
                <Card.Footer>
