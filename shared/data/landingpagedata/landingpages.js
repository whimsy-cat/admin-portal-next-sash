...
import { Features, Testimonials } from './DataLandingPage';
                    ...
                    <div className="hor-header header">
                        <Container className="main-container">
                            <div className="d-flex">
                                <Link aria-label="Hide Sidebar" className="app-sidebar__toggle" data-bs-toggle="sidebar" href="#" onClick={() => sidebarToggled()}></Link>
                                {/* <!-- sidebar-toggle--> */}
                                <Link className="logo-horizontal " href={`/components/dashboard/dashboard/`}>
                                    <img src={"../../../assets/images/brand/logo-white.png"} className="header-brand-img desktop-logo" alt="logo" />
                                    <img src={"../../../assets/images/brand/logo-dark.png"} className="header-brand-img light-logo1" alt="logo" />
                                </Link>
                                {/* <!-- LOGO --> */}
                                    ...
                                    <div className="responsive-navbar p-0" id="basic-navbar-nav">
                                        <NavbarCollapse className=" bg-white px-0" id="navbarSupportedContent-4">
                                            ...
                                            <div className="header-nav-right p-5">
                                                <Link href={`/components/authentication/register/`} className="btn ripple btn-min w-sm btn-outline-primary me-2">New User
                                                </Link>
                                                <Link href={`/components/authentication/login/`} className="btn ripple btn-min w-sm btn-primary me-2">Login
                                                </Link>
                                            </div>
                                        </NavbarCollapse>
                                    </div>
                                ...
                                <Container>
                                    <Row>
                                        <Navbar className="main-sidemenu navbar px-0 justify-content-between">
                                            <NavbarBrand className="ps-0 d-none d-lg-block" href={`/components/dashboard/dashboard/`}>
                                                <img alt="logo-3" className="logo-2" src={"../../../assets/images/brand/logo-dark.png"} />
                                                <img src={"../../../assets/images/brand/logo-white.png"} className="logo-3" alt="logo" />
                                            </NavbarBrand>
                                            ...
                                            <div className="header-nav-right d-lg-flex d-none">
                                                <Link href={`/components/authentication/register/`} className="btn ripple btn-min w-sm btn-outline-primary me-2 my-auto d-lg-none d-xl-block d-block">New User
                                                </Link>
                                                <Link href={`/components/authentication/login/`} className="btn ripple btn-min w-sm btn-primary me-2 my-auto d-lg-none d-xl-block d-block">Login
                                                </Link>
                                            </div>
                            ...
                            <Container className="px-sm-0">
                                <Row>
                                    <Col xl={6} lg={6} className="mb-5 pb-5 animation-zidex pos-relative">
                                        ...
                                        <Link href="#" className="btn ripple btn-min w-lg mb-3 me-2 btn-primary"><i className="fe fe-play mx-2"></i> Get Started</Link>
                                        <Link href="#" className="btn ripple btn-min w-lg btn-outline-primary mb-3 me-2"><i className="fe fe-eye mx-2"></i>Discover More</Link>
                                    </Col>
                                    <Col xl={6} lg={6} className="my-auto"><img src={"../../../assets/images/landing/3.png"} alt="landing" /></Col>
                                </Row>
                            </Container>
                        </div>
                    </div>
                                                                ...
                                                                <Row>
                                                                    <Col xl={6} lg={6} className="ps-0">
                                                                        <div className="text-center mb-3" >
                                                                            <img src={"../../../assets/images/landing/1.png"} alt="" className="br-5" />
                                                                        </div>
                                                                    </Col>
                                                                ...
                                                                <Accordion>
                                                                    <Accordion.Item eventKey="0" className='mb-5  bg-primary-transparent'>
                                                                        ...
                                                                        <Accordion.Body>
                                                                            ...
                                                                            <Link href="#" target="_blank" className="btn btn-outline-primary tx-13">Click here</Link>
                                                                        </Accordion.Body>
                                                                    </Accordion.Item>
                                                                </Accordion>
                                                            </Col>
                                                                ...
                                                                <Accordion>
                                                                    <Accordion.Item eventKey="0" className='mb-5 bg-success-transparent'>
                                                                        ...
                                                                        <Accordion.Body>
                                                                            ...
                                                                            <Link href="#" target="_blank" className="btn btn-outline-success tx-13">Click here</Link>
                                                                        </Accordion.Body>
                                                                    </Accordion.Item>
                                                                </Accordion>
                                                            </Col>
                                                                ...
                                                                <Accordion>
                                                                    <Accordion.Item eventKey="0" className='mb-5 bg-secondary-transparent'>
                                                                        ...
                                                                        <Accordion.Body>
                                                                            ...
                                                                            <Link href="#" target="_blank" className="btn btn-outline-secondary tx-13">Click here</Link>
                                                                        </Accordion.Body>
                                                                    </Accordion.Item>
                                                                </Accordion>
                                                            </Col>
                                                                ...
                                                                <Accordion>
                                                                    <Accordion.Item eventKey="0" className='mb-5 bg-warning-transparent'>
                                                                        ...
                                                                        <Accordion.Body>
                                                                            ...
                                                                            <Link href="#" target="_blank" className="btn btn-outline-warning tx-13">Click here</Link>
                                                                        </Accordion.Body>
                                                                    </Accordion.Item>
                                                                </Accordion>
                                                            </Col>
                                                                ...
                                                                <Accordion>
                                                                    <Accordion.Item eventKey="0" className='mb-5 bg-danger-transparent'>
                                                                        ...
                                                                        <Accordion.Body>
                                                                            ...
                                                                            <Link href="#" target="_blank" className="btn btn-outline-danger tx-13">Click here</Link>
                                                                        </Accordion.Body>
                                                                    </Accordion.Item>
                                                                </Accordion>
                                                            </Col>
                                            ...
                                            <Row>
                                                    ...
                                                    <Card className="bg-transparent">
                                                        <Card.Body className="px-1">
                                                            <div className="d-sm-flex overflow-visible">
                                                                <img className="card-aside-column br-5 cover-image" alt='media-12' src={"../../../assets/images/media/12.jpg"} />
                                                                <div className="ps-3 flex-column">
                                                                    <Badge bg="primary" className="me-1 mb-1 mt-1">Business</Badge>
                                                                    <h3><Link href={`/components/pages/extension/blog-details/`}>Voluptatem quia voluptas...</Link></h3>
                                                ...
                                                <Col lg={6}>
                                                    <Card className="bg-transparent">
                                                        <Card.Body className="px-1">
                                                            <div className="d-sm-flex overflow-visible">
                                                                <img className="card-aside-column br-5 cover-image" alt='media-22' src={"../../../assets/images/media/22.jpg"} />


                                                                <div className="ps-3 flex-column">
                                                                    <Badge bg="danger" className="me-1 mb-1 mt-1">Lifestyle</Badge>
                                                                    <h3><Link href={`/components/pages/extension/blog-details/`}>Generator on the Internet..</Link></h3>
                                                                    <div className="">Excepteur sint occaecat cupidatat non proident, accusantium sunt in culpa qui officia deserunt mollit anim id est laborum....</div>
                                                                </div>
                                                            </div>
                                                        </Card.Body>
                                                ...
                                                <Col lg={6}>
                                                    <Card className="bg-transparent">
                                                        <Card.Body className="px-1">
                                                            <div className="d-sm-flex overflow-visible">
                                                                <img className="card-aside-column br-5 cover-image" alt='about' src={"../../../assets/images/media/27.jpg"} />
                                                ...
                                                <Col lg={6}>
                                                    <Card className="bg-transparent">
                                                        <Card.Body className="px-1">
                                                            <div className="d-sm-flex overflow-visible">
                                                                <img className="card-aside-column br-5 cover-image" alt='media-25' src={"../../../assets/images/media/25.jpg"} />
                                                ...
                                                <div className="text-center mt-5">
                                                    <Link href={`/components/pages/extension/blog/`} className="btn btn-outline-primary pt-2 pb-2" target="_blank"><i className="fe fe-arrow-right mx-2"></i>Discover More</Link>
                                                                ...
                                                                <Col xl={9}>
                                                                    <div className="">
                                                                        <form className="form-horizontal m-t-20">
                                                                            ...
                                                                            <div className="px-4">
                                                                                <Link href="#" className="btn btn-primary btn-rounded  waves-effect waves-light">Submit</Link>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                </Col>
                                                            ...
                                                            <Card.Body className="pt-5 px-7">
                                                                <Row>
                                                                    ...
                                                                    <Col lg={9} className="text-end my-auto">
                                                                        <Link href="https://themeforest.net/item/sash-bootstrap-5-admin-dashboard-template/35183671" target="_blank" className="btn btn-pink w-lg pt-2 pb-2"><i className="fe fe-shopping-cart mx-2"></i>Buy Now
                                                                        </Link>
                                                                    </Col>
                                                                </Row>
                                                            </Card.Body>
                            ...
                            <Card>
                                <Card.Body>
                                        ...
                                        <Row>
                                            ...
                                            <Col lg={2} sm={6} md={4} className="">
                                                ...
                                                <ul className="list-unstyled mb-5 mb-lg-0">
                                                    ...
                                                    <li><Link href={`/components/bootstrap/alerts/`}>Elements</Link></li>
                                                    <li><Link href={`/components/pages/forms/form-elements/`}>Forms</Link></li>
                                                    <li><Link href={`/components/charts/chartjs/`}>Charts</Link></li>
                                                    <li><Link href={`/components/pages/tables/data-table/`}>Tables</Link></li>
                                                    <li><Link href={`/components/filemanager/file-attachments/`}>Other Pages</Link></li>
                                                </ul>
                                            </Col>
                                            <Col lg={2} sm={6} md={4} className="">
                                                <h6>Information</h6>
                                                <ul className="list-unstyled mb-5 mb-lg-0">
                                                    <li><Link href={`/components/pages/extension/about-company/`}>Our Team</Link></li>
                                                    <li><Link href={`/components/pages/extension/about-company/`}>Contact US</Link></li>
                                                    <li><Link href={`/components/pages/extension/about-company/`}>About</Link></li>
                                                    <li><Link href={`/components/pages/extension/services/`}>Services</Link></li>
                                                    <li><Link href={`/components/pages/extension/blog/`}>Blog</Link></li>
                                                    <li><Link href={`/components/pages/extension/terms/`}>Terms and Services</Link></li>
                                                </ul>
                                            </Col>
                                            <Col lg={4} sm={12} md={4} className="">
                                                <div className="">
                                                    <Link href={`/components/dashboard/dashboard/`}><img loading="lazy" alt="" className="logo mb-3" src="..assets/images/brand/logo-dark" /></Link>
                                    ...
                                    <footer className="main-footer px-0 pb-0 text-center">
                                        <Row>
                                            <Col md={12} sm={12}>
                                                Copyright © <span id="year"></span> <Link href="#">Sash</Link>. Designed with <span className="fa fa-heart text-danger"></span> by <Link href="#"> Spruko </Link> All rights reserved.
                                            </Col>
                                        </Row>
                                    </footer>
                                </Card.Body>
