...
import { TotalRevenue, SupportCost, TotalRequest, RequestsAnswered, Gallery } from './DataWidgets';
          ...
          <Card>
            <Card.Header className="pb-0 border-bottom-0">
              ...
              <div className="card-options">
                <Link className="btn btn-sm btn-primary" href="#"><i className="fa fa-bar-chart mb-0"></i></Link>
              </div>
            </Card.Header>
        ...
        <Col sm={6} md={6} lg={6} xl={3}>
          <Card>
            <Card.Header className="pb-0 border-bottom-0">
              ...
              <div className="card-options">
                <Link className="btn btn-sm btn-success" href="#"><i className="fa fa-send-o mb-0"></i></Link>
              </div>
            </Card.Header>
            <Card.Body className="pt-0">
        ...
        <Col sm={6} md={6} lg={6} xl={3}>
          <Card>
            <Card.Header className="pb-0 border-bottom-0">
              ...
              <div className="card-options">
                <Link className="btn btn-sm btn-warning" href="#"><i className="fa fa-mail-reply mb-0"></i></Link>
              </div>
            </Card.Header>
            <Card.Body className="pt-0">
        ...
        <Col sm={6} md={6} lg={6} xl={3}>
          <Card>
            <Card.Header className="pb-0 border-bottom-0">
              ...
              <div className="card-options">
                <Link className="btn btn-sm btn-danger" href="#"><i className="fa fa-money mb-0"></i></Link>
              </div>
            </Card.Header>
            <Card.Body className="pt-0">
            ...
            <Row>
              <div className="col-4">
                <div className="circle-icon bg-primary text-center align-self-center box-primary-shadow bradius overflow-hidden">
                  <img src={"../../../assets/images/svgs/circle.svg"} alt="img" className="card-img-absolute" />
            ...
            <Card.Body>
              <div className="media mb-5 mt-0">
                <div className="d-flex me-3">
                  <Link href="#"> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={"../../../assets/images/users/18.jpg"} /> </Link>
                </div>
                <div className="media-body">
                  <Link href="#" className="text-dark">Nathaniel Bustos</Link>
              ...
              <div className="media mb-5">
                <div className="d-flex me-3">
                  <Link href="#"><img className="media-object rounded-circle thumb-sm" alt="64x64" src={"../../../assets/images/users/4.jpg"} /></Link>
                </div>
                <div className="media-body">
                  <Link href="#" className="text-dark">Latanya Kinard</Link>
              ...
              <div className="media mb-5">
                <div className="d-flex me-3">
                  <Link href="#"> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={"../../../assets/images/users/20.jpg"} /> </Link>
                </div>
                <div className="media-body">
                  <Link href="#" className="text-dark">George Lujan</Link>
              ...
              <div className="media mb-5">
                ...
                <div className="media-body">
                  <Link href="#" className="text-dark">Rose Bush</Link>
                  <div className="text-muted small">Web Designer</div>
                </div>
              ...
              <div className="media mb-0">
                <div className="d-flex me-3">
                  <Link href="#"> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={"../../../assets/images/users/19.jpg"} /> </Link>
                </div>
                <div className="media-body">
                  <Link href="#" className="text-dark">Samantha</Link>
                  <div className="text-muted small">Manager</div>
                </div>
