  ...
  let myfunction = (InputData) => {
    ...
    for (allElement of allData) {
      ...
      if (allElement.heading.toLowerCase().includes(InputData.toLowerCase())) {
        if (
          allElement.heading.toLowerCase().startsWith(InputData.toLowerCase())
        ) {
                ...
                <Card.Body>
                  <div className="">
                    ...
                    {/* <div className="d-flex overflow-visible mt-5">
                      <img className="avatar bradius avatar-xl me-4 p-2 bg-white border" src={"../../../assets/images/pngs/5.png"} alt="avatar-img" />
                      <div className="media-body valign-middle">
                        <Link href="#" className="fw-semibold text-dark">Chair</Link>
                        <div className="mb-1 text-warning">
                          <i className="fa fa-star"></i>
                          <i className="fa fa-star"></i>
                          <i className="fa fa-star"></i>
                    ...
                    <Row>
                      ...
                      <Col xl={3} lg={12}>
                        <Link
                          ...
                          className="btn btn-primary btn-block float-end my-2"
                        >
                              ...
                              <Card>
                                <div className="product-grid6">
                                  ...
                                  <Card.Footer className="text-center">
                                    ...
                                    <Link
                                      href={`/components/e-commerce/wishlist/`}
