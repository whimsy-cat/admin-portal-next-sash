...
import { relatedproductData } from "../../../shared/data/dataecommerce/dataproductdetails";
import { connect } from "react-redux";
import { AddToCart } from "../../../shared/redux/action";
// photos

import { ItemData } from "../../../shared/data/dataecommerce/reduxdata";
...
const ProductDetails = ({ local_varaiable, AddToCart }) => {
  ...
  useEffect(() => {
    if (id !== undefined) {
      ...
      setdefaultData({
        id: Math.random(),
        preview: "../../../assets/images/png/5.png",
        imges: [
          { img: "../../../assets/images/png/5.png" },
          { img: "../../../assets/images/png/8.png" },
          { img: "../../../assets/images/png/6.png" },
          { img: "../../../assets/images/png/7.png" },
        ],
        heading:
          "Trending Half Hands Tshirt (Best Fabric Premium made T-shirt for Casual wear.)",
        price2: "$599",
        price1: "$299 USD/",
        status: "In Stock",
        bg: "success",
                ...
                <Col xl={7} lg={12} md={12} className="details mt-4 mt-xl-0">
                  <div className="mt-2 mb-4">
                    <h3 className="mb-3 fw-semibold">
                      {defaultData && defaultData.heading}
                    </h3>
                    ...
                    <h3 className="mb-4">
                      <span className="me-2 fw-bold fs-25">
                        {defaultData && defaultData.price1}
                      </span>
                      <span>
                        <del className="fs-18 text-muted">
                          {defaultData && defaultData.price2}
                        </del>
                      </span>
                    </h3>
                    <div className=" mt-4 mb-5 d-inline-flex">
                      ...
                      <Col>
                        <div className="mb-2 me-2 sizes">
                          ...
                          <InputGroup className="input-indec input-indec1 w-30 w-sm-50 mt-3">
                            ...
                            <span className="form-control text-center qty">
                              {num}
                            </span>
                            <span className="input-group-btn">
                              <Button
                    ...
                    <div className="btn-list mt-4">
                      <Link
                        href={`/components/e-commerce/shopping-cart/`}
                        onClick={() => {
                          AddToCart(id);
                        }}
                      ...
                      <Link
                        href={`/components/e-commerce/checkout/`}
                        onClick={() => {
                          AddToCart(id);
                        }}
            ...
            <Card>
              <div className="product-grid6">
                <div className="product-image6 p-5">
                  <ul className="icons">
                    <li>
                      <Link
                        href={`/components/e-commerce/shopping-cart/`}
                        className="btn bg-primary text-white border-primary border"
                      >
                        {" "}
                    ...
                    <li>
                      <Link
                        href={`/components/e-commerce/add-product/`}
                        className="btn bg-success text-white border-success border"
                      >
                    ...
                    <li>
                      <Link
                        href="#"
                        className="btn bg-danger text-white border-danger border"
                  ...
                  <Link
                    href={`/components/e-commerce/product-details/`}
                    className="bg-light"
                  >
                    <img
                ...
                <Card.Body className="pt-0">
                  <div className="product-content text-center">
                    <h1 className="title fw-bold fs-20">
                      <Link href={`/components/e-commerce/product-details/`}>
                        {idx.heading}
                      </Link>
                    </h1>
                    ...
                    <div className="price">
                      {idx.price1}
                      <span className="ms-4">{idx.price2}</span>
                    </div>
                  </div>
                </Card.Body>
                <Card.Footer className="text-center">
                  ...
                  <Link href={`/components/e-commerce/wishlist/`}>
                    <button
                      type="button"
