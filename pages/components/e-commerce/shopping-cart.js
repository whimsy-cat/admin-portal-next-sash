...
import { shopingData } from "../../../shared/data/dataecommerce/datashoppingcart";
                    ...
                    {FiltershopingData !== "" ? (
                        ...
                        <tr key={Math.random()}>
                          ...
                          <td>
                            ...
                            >
                              <Button
                                variant="default"
                                className="counter-minus lh-2 shadow-none btn-white"
                                onClick={dec}
                              >
                              ...
                              <Button
                                variant="default"
                                className="counter-plus lh-2 shadow-none btn-white"
                                onClick={inc}
                              >
                          ...
                          <td ref={containerRef} className="listprice2">
                            {list.price2}
                          </td>
                      ...
                      <tr>
                        <td className="text-danger">
                          {`"There `}is no product available in {`the Cart"`}
                        </td>
                      </tr>
                    )}
                  </tbody>
          ...
          <Card>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="text-end">
                        <span className="fw-bold  ms-auto">$14,675</span>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-end">
                        <span className="ms-2 fw-bold fs-23">$12,466</span>
                      </td>
                    </tr>
                  </tbody>
                </Table>
            ...
            <Card.Footer>
              <div className="btn-list d-flex justify-content-between flex-wrap">
                <Link
                  href={`/components/e-commerce/shop/`}
...
ShoppingCart.layout = "Contentlayout";
