...
const Checkout = ({ local_varaiable }) => {
  ...
  let checkOutData = [
    {
      id: 4,
      preview: "../../../assets/images/products/3.jpg",
                    ...
                    <Tab.Content>
                      <Tab.Pane eventKey="CreditCard">
                        <div className="tab-pane active show" id="tab20">
                          <div
                            className="bg-danger-transparent-2 text-danger br-3 mb-4 mt-5"
                            role="alert"
                          >
                          ...
                          <Form.Group>
                            ...
                            <InputGroup>
                              ...
                              <InputGroup.Text className="input-text-color">
                                <i className="fa fa-cc-visa text-muted"></i>{" "}
                                &nbsp;{" "}
                                <i className="fa fa-cc-amex text-muted"></i>{" "}
                                &nbsp;
              ...
              {FiltercartData.map((idx) => (
                <div className="" key={Math.random()}>
                  <div className="d-flex">
                    <img
                      className="avatar-xxl br-7 mb-1"
                      src={idx.preview}
                      alt="img"
                    />
                    <div className="ms-3">
