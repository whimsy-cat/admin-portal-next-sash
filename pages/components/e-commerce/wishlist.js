                          ...
                          <div className="product-grid6">
                            ...
                            <Card.Body className="pt-0">
                              <div className="product-content text-center">
                                ...
                                <span
                                  className={`text-${idx.bg} fs-18 fw-semibold`}
                                >
                                  {idx.status}
                                </span>
                              </div>
                            ...
                            <Card.Footer className="text-center">
                              ...
                              >
                                <i className="fe fe-shopping-cart me-2"></i>Add
                                to cart
                              </Link>
                              <Link
                                href="#"
                                className="btn btn-light ms-2 mb-1"
                              >
                                <i className="fe fe-share-2 me-2 text-dark"></i>
                                Share
                              </Link>
                            </Card.Footer>
                          </div>
