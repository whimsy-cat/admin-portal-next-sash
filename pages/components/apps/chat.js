...
import { Media } from "../../../shared/data/app/datachat";
                    ...
                    <Nav className="ms-auto">
                      <Dropdown>
                        ...
                        <Dropdown.Menu className="dropdown-menu-end">
                          ...
                          <Dropdown.Item href="#">
                            <i className="fe fe-users me-1"></i> New Group
                          </Dropdown.Item>
                          <Dropdown.Item href="#">
                  ...
                  <Card.Body>
                    ...
                    <PerfectScrollbar>
                      <div className="main-chat-contacts-wrapper d-none d-sm-block">
                        <Form.Label className="mb-2 fs-13">
                          Online Users
                        </Form.Label>
                    ...
                    <Tab.Content className=" main-chat-list flex-2">
                      <Tab.Pane eventKey="msg">
                        <div className="main-chat-list tab-pane">
                          <Link className="media new border-top-0" href="#">
                            <div className="main-img-user online">
                              <img
                                alt="user5"
                                src={"../../../assets/images/users/5.jpg"}
                          ...
                          <Link className="media new border-bottom-0" href="#">
                            <div className="main-img-user">
                              <img
                                alt="user6"
                                src={"../../../assets/images/users/6.jpg"}
                      ...
                      <Tab.Pane eventKey="net">
                        <div>
                          ...
                          <Link href="#" className="align-items-center media">
                            <div className="align-items-center justify-content-between">
              ...
              <Card.Body className="profile-details-main pb-0">
                <div className="main-content-app">
                  <Nav className="float-end">
                    <Dropdown>
                      <Dropdown.Toggle
                        className="text-muted fs-20 p-0 ps-3 no-caret"
                        as="a"
                      >
                  ...
                  <div className="text-center chat-image p-4 pb-0 mb-4 br-5">
                    ...
                    <div className="main-chat-msg-name">
                      ...
                      <span className="dot-label bg-success"></span>
                      <small className="me-3">Available</small>
                      <p className="text-muted mt-0 mb-1 pt-0 fs-13">
                        Senior Web Designer
                      </p>
                    </div>
                  </div>
                  <div className="">
                    ...
                    <div className="d-flex mb-2">
                      ...
                      <div className="ms-2">
                        ...
                        <p className="fs-12 text-muted text-break">
                          ryangracie435@gmail.com.
                        </p>
                      </div>
                    </div>
                              ...
                              <div className="d-flex align-items-center">
                                <div className="mt-0">
                                  ...
                                  <p className="mb-0 fs-13 text-muted">
                                    ppt
                                    <span className="fs-11 mx-2">1.2 mb</span>
                                  </p>
                                </div>
                            ...
                            <div className="media-body">
                              <div className="d-flex align-items-center">
                                <div className="mt-0">
                                  ...
                                  <p className="mb-0 fs-13 text-muted">
                                    img<span className="fs-11 mx-2">12 mb</span>
                                  </p>
                                </div>
                                <span className="ms-auto fs-14">
                                  <span className="float-end">
                            ...
                            <div className="media-body">
                              <div className="d-flex align-items-center">
                                <div className="mt-0">
                                  ...
                                  <p className="mb-0 fs-13 text-muted">
                                    Video
                                    <span className="fs-12 mx-2">16 mb</span>
                                  </p>
                                </div>
                                <span className="ms-auto fs-14">
                                  <span className="float-end">
