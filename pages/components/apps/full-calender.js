...
class FullCalenderComponent extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <PageHeader
          titles="Full Calendar"
          active="Full Calendar"
          items={["Apps"]}
        />
        <Row>
          <Col md={12}>
                    ...
                    <div className="mt-5">
                      ...
                      <Card className="border p-0 pt-3">
                        <Card.Body className="pt-3">
                          <Dropdown>
                            <Dropdown.Toggle
                              className="float-end text-muted pe-0 pt-0 no-caret"
                              as="a"
                            >
                            ...
                            <Dropdown.Menu>
                              <Dropdown.Item href="#">
                                <i className="fe fe-edit me-1"></i> Shedule Date
                              </Dropdown.Item>
                              <Dropdown.Item href="#">
                      ...
                      <Card className="border p-0 pt-3">
                        <Card.Body className="pt-3">
                          ...
                          <Link href="#" className="btn btn-danger btn-sm mb-3">
                            Online Meeting
                          </Link>
                        </Card.Body>
                        <Card.Footer>
              ...
              <Card.Body>
                <div className="list-calender">
                  <FullCalendar
                    ...
                    plugins={[listWeek]}
                    events={this.state.calendarEvents1}
                  />
                </div>
              </Card.Body>
            </Card>
