        ...
        <Col md={12}>
          <Card className="mg-b-20">
            <Card.Body>
              ...
              <p className="mg-b-20 card-sub-title fs-12 text-muted">
            ...
            <Col xl={8}>
              <Card>
                <Card.Body>
                  ...
                  <p className="mg-b-20 card-sub-title fs-12 text-muted">
                    It is Very Easy to Customize and it uses in website
                    apllication.
                  </p>
                  <Row>
                    {/* <!-- col --> */}
                  ...
                  <div className="dTree">
                    ...
                    >
                      ...
                      >
                        ...
                        <StyledTreeItem
                          nodeId="7"
                          labelText="Mercedes - Benz"
                          labelIcon={DirectionsCarIcon}
                        >
                          <StyledTreeItem
                            nodeId="8"
                            labelText="About the Mercedes - Benz"
                            labelIcon={InfoIcon}
                            color="#1a73e8"
                            bgColor="#e8f0fe"
                          />
                          ...
                          >
                            ...
                            <StyledTreeItem
                              nodeId="26"
                              labelText="Best Prototypes"
                              labelIcon={FormatAlignCenterIcon}
                              color="#1a73e8"
                              bgColor="#e8f0fe"
                            />
                            <StyledTreeItem
                              nodeId="27"
                              labelText="List all other categories"
                              labelIcon={ListIcon}
                            />
                          </StyledTreeItem>
                          <StyledTreeItem
                            nodeId="28"
                            labelText="Custom Series"
                            labelIcon={DashboardCustomizeIcon}
                            color="#1a73e8"
                            bgColor="#e8f0fe"
                          />
                          <StyledTreeItem
                            nodeId="29"
                            labelText="A+ Series for children"
                            labelIcon={PersonIcon}
                          />
                          <StyledTreeItem
                            nodeId="30"
                            labelText="B+ Series for women"
                            labelIcon={PersonIcon}
                          />
                        </StyledTreeItem>
                        <StyledTreeItem
                        ...
                        >
                          ...
                          <StyledTreeItem
                            nodeId="37"
                            labelText="Dogan Gorunumlu Sahin"
                            labelIcon={Label}
                          >
                            <StyledTreeItem
                              nodeId="38"
                      ...
                      <StyledTreeItem
                        nodeId="44"
                        labelText="Electronic Models"
                        labelIcon={ElectricMeterIcon}
                        color="#1a73e8"
                        bgColor="#e8f0fe"
                      />
                      <StyledTreeItem
                      ...
                      <StyledTreeItem
                        nodeId="47"
                        labelText="Graphics"
                        labelIcon={AutoGraphIcon}
                        color="#1a73e8"
                        bgColor="#e8f0fe"
                      />
                      <StyledTreeItem
                        nodeId="48"
                        labelText="Smart Phones"
                      ...
                      >
                        ...
                        <StyledTreeItem
                          nodeId="56"
                          labelText="Other Models"
                          labelIcon={SmartphoneIcon}
                        >
                          <StyledTreeItem
                            nodeId="57"
                            labelText="First other model"
                            labelIcon={SmartphoneIcon}
                            color="#1a73e8"
                            bgColor="#e8f0fe"
                          />
