    ...
    <div>
      ...
      <Row className="row-cards">
        ...
        <Col md={12} xl={4}>
          <Card>
            <Card.Header>
              <Card.Title>Time Counting From 60 to 20</Card.Title>
            </Card.Header>
            <Card.Body>
        ...
        <Col md={12} xl={4}>
          <Card>
            <Card.Header>
              <Card.Title as="h3">Time minutes counter</Card.Title>
            </Card.Header>
            <Card.Body>
        ...
        <Col md={12} lg={4} xl={4}>
          <Card>
            <Card.Header>
              <Card.Title>Numbers counter</Card.Title>
            </Card.Header>
