              ...
              <Tab.Pane eventKey="all">
                ...
                <Card>
                  <Card.Body>
                    <div className="mb-2">
                      <Link href="#" className="h4 text-dark">
                        Zendash - Bootstrap HTML Dashboard Template
                      </Link>
                    </div>
                    <Link href="#" className="text-primary">
                      https://www.spruko.com/demo/zendash/html/
                    </Link>
                    <p className="text-muted mt-2 mb-1">
                      Treal Template included in 30 versions. In the demo 30
                      versions is shown in 4 floders. And In the final each
                      version has single floder corresponding to that ...
                    </p>
                    <p className="text-muted  mb-2">
                      Tags: admin, admin dashboard, admin panel, admin template,
                      backend, bootstrap, bootstrap 4, clean, dashboard, flat,
                      jquery, modern, premium admin templates ...
                    </p>
                    <div>
                      <Link href="#">
                        <i className="fa fa-star text-yellow fs-16"></i>
                ...
                <Card>
                  <Card.Body>
                    <div className="mb-2">
                      <Link href="#" className="h4 text-dark">
                        Zendash template related Images
                      </Link>
                    </div>
                ...
                <Card>
                  <Card.Body>
                    <div className="mb-2">
                      <Link href="#" className="h4 text-dark">
                        Eduserv Website Templates from ThemeForest
                      </Link>
                    </div>
                    <Link href="#" className="text-primary">
                      https://spruko.com/demo/eduserv/html/
                    </Link>
                    <p className="text-muted mt-2 mb-2">
                      Nemo enim ipsam voluptatem quia voluptas sit aspernatur
                      aut odit aut fugit, sed quia consequuntur magni dolores
                ...
                <Card>
                  <Card.Body>
                    <div className="mb-2">
                      <Link href="#" className="h4 text-dark">
                        HostOne – Web Hosting HTML Creative Responsive Clean
                        Template
                      </Link>
                    </div>
                    <Link href="#" className="text-primary">
                      https://www.spruko.com/demo/hostone/html/
                    </Link>
                    <p className="text-muted mt-2 mb-1">
                      {" "}
                      HostOne - Web Hosting HTML Creative Responsive Clean
                      Template by sprukosoft HostOne -HTML Templates is a Clean,
