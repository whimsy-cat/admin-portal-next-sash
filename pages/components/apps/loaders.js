            ...
            <Card>
              <Card.Header>
                ...
                <div className="card-options">
                  <Link href="#" onClick={loderHandleExpandClick}>
                    <i
                      className={`fe ${
                        loderExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
                    href="#"
                    onClick={() => setloderShow(false)}
                    aria-label="close"
                  >
          ...
          {cubeShow ? (
            <Card>
              <Card.Header>
                <Card.Title>loaders</Card.Title>
                <div className="card-options">
                  <Link href="#" onClick={cubeHandleExpandClick}>
                    <i
                      className={`fe ${
                        cubeExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
                    href="#"
                    onClick={() => setcubeShow(false)}
                    aria-label="close"
                  >
                    <i className="fe fe-x"></i>
                  </Link>
          ...
          {spinnerShow ? (
            <Card>
              <Card.Header>
                <Card.Title>loaders</Card.Title>
                <div className="card-options">
                  <Link href="#" onClick={spinnerHandleExpandClick}>
                    <i
                      className={`fe ${
                        spinnerExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
                    href="#"
                    onClick={() => setspinnerShow(false)}
                    aria-label="close"
                  >
                    <i className="fe fe-x"></i>
                  </Link>
          ...
          {show ? (
            <Card>
              <Card.Header>
                <Card.Title>loaders</Card.Title>
                <div className="card-options">
                  <Link href="#" onClick={handleExpandClick}>
                    <i
                      className={`fe ${
          ...
          {hourShow ? (
            <Card>
              <Card.Header>
                <Card.Title>loaders</Card.Title>
                <div className="card-options">
                  <Link href="#" onClick={hourHandleExpandClick}>
                    <i
                      className={`fe ${
                        hourExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
                    href="#"
                    onClick={() => sethourShow(false)}
                    aria-label="close"
                  >
                    <i className="fe fe-x"></i>
                  </Link>
          ...
          {heartShow ? (
            <Card>
              <Card.Header>
                <Card.Title>loaders</Card.Title>
                <div className="card-options">
                  <Link href="#" onClick={hearthandleExpandClick}>
                    <i
                      className={`fe ${
                        heartExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
                    href="#"
                    onClick={() => setheartShow(false)}
                    aria-label="close"
                  >
                    <i className="fe fe-x"></i>
                  </Link>
