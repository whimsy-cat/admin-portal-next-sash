...
const CardsDesign = () => {
  ...
  const defaultCard = [
    {
      id: "1",
      class: "text-primary bg-primary-transparent card-transparent",
      class1: "Primary",
    },
    {
      id: "2",
      class: "text-secondary bg-secondary-transparent card-transparent",
      class1: "Secondary",
    },
    {
      id: "3",
      class: "text-success bg-success-transparent card-transparent",
      class1: "Success",
    },
    {
      id: "4",
      class: "text-danger bg-danger-transparent card-transparent",
      class1: "Danger",
    },
    {
      id: "5",
      class: "text-info bg-info-transparent card-transparent",
      class1: "Info",
    },
    {
      id: "6",
      class: "text-warning bg-warning-transparent card-transparent",
      class1: "Warning",
    },
  ];
            ...
            <Card className="border p-0">
              <Card.Header>
                ...
                <div className="card-options">
                  <Link href="#" onClick={contactHandleExpandClick}>
                    {" "}
                    <i
                      className={`fe ${
                        contactExpanded1 ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
                    href="#"
                    onClick={() => setcontactShow1(false)}
                    aria-label="close"
                  >
          ...
          {contactShow2 ? (
            <Card className="border p-0">
              <Card.Header>
                <Card.Title>Contact card</Card.Title>
                <div className="card-options">
                  <Link href="#" onClick={cardHandleExpandClick2}>
                    {" "}
                    <i
                      className={`fe ${
                        cardExpanded2 ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
                    href="#"
                    onClick={() => setcontactShow2(false)}
                    aria-label="close"
                  >
                    <i className="fe fe-x"></i>
                  </Link>
          ...
          {cardShow3 ? (
            <Card className="border p-0">
              <Card.Header>
                <Card.Title>Contact card</Card.Title>
                <div className="card-options">
                  <Link href="#" onClick={cardHandleExpandClick3}>
                    {" "}
                    <i
                      className={`fe ${
                        cardExpanded3 ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
                    href="#"
                    onClick={() => setcardShow3(false)}
                    aria-label="close"
                  >
                    <i className="fe fe-x"></i>
                  </Link>
          ...
          {cardShow4 ? (
            <Card className="border p-0">
              <Card.Header>
                <Card.Title>Contact card</Card.Title>
                <div className="card-options">
                  <Link href="#" onClick={cardHandleExpandClick4}>
                    {" "}
                    <i
                      className={`fe ${
                        cardExpanded4 ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
                    href="#"
                    onClick={() => setcardShow4(false)}
                    aria-label="close"
                  >
                    <i className="fe fe-x"></i>
                  </Link>
          ...
          {Colorshow ? (
            <Card>
              <Card.Header className="bg-primary br-te-3 br-ts-3">
                ...
                <div className="card-options ">
                  <Link href="#" onClick={ColorHandleExpandClick}>
          ...
          {Footershow ? (
            <Card>
              <Card.Header>
                ...
                <div className="card-options">
                  <Link href="#" onClick={FooterHandleExpandClick}>
                    {" "}
                    <i
                      className={`fe ${
          ...
          <Card>
            <Card.Header>
              ...
              <div className="card-options">
                ...
                <Link href="#" className="btn btn-secondary btn-sm ms-2">
                  Action 2
                </Link>
              </div>
            </Card.Header>
          ...
          {successshow ? (
            <Card>
              <Card.Header>
                ...
                <div className="card-options">
                  <Link href="#" onClick={successHandleExpandClick}>
                    {" "}
                    <i
                      className={`fe ${
                        successExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
          ...
          {dangershow ? (
            <Card>
              <Card.Header>
                <Card.Title>Card with alert</Card.Title>
                <div className="card-options">
                  <Link href="#" onClick={dangerHandleExpandClick}>
                    {" "}
                    <i
                      className={`fe ${
                        dangerExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
          ...
          {shows ? (
            <Card>
              <Card.Header>
                ...
                <div className="card-options">
                  <Link href="#" onClick={FullscreenhandleExpandClick}>
                    {" "}
                    <i
                      className={`fe ${
                  ...
                  <Link href="#" onClick={() => handleShow(true)}>
          ...
          {Initialshow ? (
            <Card>
              <Card.Header>
                ...
                <div className="card-options">
                  <Link href="#" onClick={InitialHandleExpandClick}>
                    {" "}
                    <i
                      className={`fe ${
          ...
          {Listshow ? (
            <Card className="m-b-20">
              <Card.Header>
                ...
                <div className="card-options">
                  <Link href="#" onClick={ListHandleExpandClick}>
                    {" "}
                    <i
                      className={`fe ${
                        ListExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
                    ...
                    <div className="visitor-list">
                      <div className="media m-0 mt-0 border-bottom">
                        ...
                        <div className="media-body">
                          <Link href="#" className="text-default fw-semibold">
                            John Paige
                          </Link>
                      ...
                      <div className="media mt-2 border-bottom">
                        <img
                          className="brround avatar-md me-3"
                          alt="avatra-img"
                          src={"../../../assets/images/users/20.jpg"}
                        />
                        <div className="media-body">
                          <Link href="#" className="text-default fw-semibold">
                            Lillian Quinn
          ...
          {sampleShow ? (
            <Card className="m-b-20">
              <Card.Header>
                ...
                <div className="card-options">
                  <Link href="#" onClick={sampleHandleExpandClick}>
                    {" "}
                    <i
                      className={`fe ${
                        SampleExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
                    href="#"
                    onClick={() => setsampleShow(false)}
                    aria-label="close"
                  >
                    <i className="fe fe-x"></i>
                  </Link>
              ...
              <Collapse in={SampleExpanded} timeout={3000}>
                <div>
                  <Card.Body>
                    <Card.Text>
                      Put toy mouse in food bowl run out of litter box at full
                      speed drool but pee in Put toy mouse Put toy mouse the
                      shoe purr when being pet but chew foot.
                    </Card.Text>
                    <Card.Text className="mb-0">
                      Scratch the postman wake up lick paw Duis aute irure dolor
                      in reprehenderit wake up owner meow meow lick plastic bags
                      Scratch the postman wake up lick paw wake Duis aute irure
                      dolor having their mate disturbing sleeping humans.
                    </Card.Text>
                  </Card.Body>
                </div>
              </Collapse>
          ...
          {ImageShow ? (
            <Card className="card-blog-overlay  overflow-hidden">
              <Card.Header className="z-index2  border-transparent">
                <Card.Title className="text-white ">card-with image</Card.Title>
                <div className="card-options">
                  <Link href="#" onClick={ImageHandleExpandClick}>
                    <i
                      className={`fe ${
                        ImageExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
          ...
          {cardShow ? (
            <Card>
              ...
              <Card.Header>
                ...
                <div className="card-options">
                  <Link href="#" onClick={cardHandleExpandClick}>
                    {" "}
                    <i
                      className={`fe ${
                        cardExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
          ...
          {statusShow ? (
            <Card>
              ...
              <Card.Header>
                ...
                <div className="card-options">
                  <Link href="#" onClick={statusHandleExpandClick}>
                    {" "}
                    <i
                      className={`fe ${
                        statusExpanded ? "fe-chevron-up" : "fe-chevron-down"
                      }`}
                    ></i>
                  </Link>
                  <Link
