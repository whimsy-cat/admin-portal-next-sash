    ...
    <div>
      ...
      <Row className="row-cards">
        ...
        <Col lg={12} xl={6}>
          <Card>
            <Card.Header>
              <Card.Title>Multi circle Rating</Card.Title>
            </Card.Header>
            <Card.Body>
              <div className="rating-stars block">
                <Box
      ...
      <Row className="row-cards">
        ...
        <Col lg={12} xl={6}>
          <Card>
            <Card.Header>
              <Card.Title>On hover event</Card.Title>
            </Card.Header>
            <Card.Body>
            ...
            <span className="live-rating"></span> */}
              ...
              >
                <Rating
                  ...
                  emptyIcon={
                    <StarsIcon style={{ opacity: 0.55 }} fontSize="inherit" />
                  }
                />
                {value !== null && (
                  <Box
                    className="rating-stars my-rating-9 rating-9"
                    sx={{ ml: 2 }}
                  >
