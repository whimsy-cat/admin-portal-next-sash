              ...
              <div className="container">
                <Row className="align-items-center flex-row-reverse">
                  <Col lg={12} sm={12} className="mt-3 mt-lg-0 text-center">
                    Copyright © 2022 <Link href="#">Sash</Link>. Designed with{" "}
            ...
            <Card.Footer className="footer border-top-0 footer-1">
              <div className="container">
                <Row className="align-items-center">
                  ...
                  <Col lg={12} sm={12} className="mt-3 mt-lg-0 text-center">
                    Copyright © 2022 <Link href="#">Sash</Link>. Designed with
                    by <Link href="#">Spruko</Link> All rights reserved.
                  </Col>
                </Row>
              </div>
            </Card.Footer>
                ...
                <Row>
                  ...
                  <Col lg={4} sm={12} md={4}>
                    ...
                    <ul className="list-unstyled mb-4">
                      ...
                      <li>
                        <Link href="#">Phno1: +123 456 8976</Link>
                      </li>
                      <li>
                        <Link href="#">Phno2: +567 234 7865</Link>
                      </li>
                      <li>
                        <Link href="#">Mail1: yourdomain@gmail.com</Link>
                      </li>
                      <li>
                        <Link href="#">Mail2: infodomain@gmail.com</Link>
                      </li>
                    </ul>
                  </Col>
                </Row>
            ...
            <Card.Body>
              <div className="top-footer">
                <Row>
                  ...
                  <Col lg={4} sm={12} md={4}>
                    <h6>Posts</h6>
                    <img alt="" src={"../../../assets/images/media/31.jpg"} />
                    <img alt="" src={"../../../assets/images/media/32.jpg"} />
                    <img alt="" src={"../../../assets/images/media/33.jpg"} />
                    <img alt="" src={"../../../assets/images/media/34.jpg"} />
                    <hr />
