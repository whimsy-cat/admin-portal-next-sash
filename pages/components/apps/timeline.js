                ...
                <div className="timeline-wrapper timeline-inverted timeline-wrapper-secondary">
                  ...
                  <div className="timeline-panel">
                    ...
                    <div className="timeline-footer d-flex align-items-center flex-wrap">
                      ...
                      <span>25</span>
                      <span className="ms-auto">
                        <i className="fe fe-calendar text-muted mx-1"></i>10th
                        Oct 2020
                      </span>
                    </div>
                  </div>
                ...
                <div className="timeline-wrapper timeline-wrapper-green">
                  ...
                  <div className="timeline-panel">
                    ...
                    <div className="timeline-footer d-flex align-items-center flex-wrap">
                      ...
                      <span>19</span>
                      <span className="ms-auto">
                        <i className="fe fe-calendar text-muted mx-1"></i>5th
                        Oct 2020
                      </span>
                    </div>
                  </div>
                ...
                <div className="timeline-wrapper timeline-inverted timeline-wrapper-danger">
                  ...
                  <div className="timeline-panel">
                    ...
                    <div className="timeline-footer d-flex align-items-center flex-wrap">
                      ...
                      <span>19</span>
                      <span className="ms-auto">
                        <i className="fe fe-calendar text-muted mx-1"></i>27th
                        Sep 2017
                      </span>
                    </div>
                  </div>
                ...
                <div className="timeline-wrapper timeline-wrapper-success">
                  ...
                  <div className="timeline-panel">
                    ...
                    <div className="timeline-footer d-flex align-items-center flex-wrap">
                      ...
                      <span>25</span>
                      <span className="ms-auto">
                        <i className="fe fe-calendar text-muted mx-1"></i>25th
                        Sep 2017
                      </span>
                    </div>
                  </div>
                ...
                <div className="timeline-wrapper timeline-inverted timeline-wrapper-warning">
                  ...
                  <div className="timeline-panel">
                    ...
                    <div className="timeline-footer d-flex align-items-center flex-wrap">
                      ...
                      <span>32</span>
                      <span className="ms-auto">
                        <i className="fe fe-calendar text-muted mx-1"></i>19th
                        Sep 2017
                      </span>
                    </div>
                  </div>
                ...
                <div className="timeline-wrapper timeline-wrapper-dark">
                  ...
                  <div className="timeline-panel">
                    ...
                    <div className="timeline-footer d-flex align-items-center flex-wrap">
                      ...
                      <span>26</span>
                      <span className="ms-auto">
                        <i className="fe fe-calendar text-muted mx-1"></i>15th
                        Sep 2017
                      </span>
                    </div>
                  </div>
