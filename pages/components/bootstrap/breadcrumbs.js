          ...
          <Card>
            ...
            <Card.Body>
              <div className="breadcrumb-style3">
                ...
                <Breadcrumb className="breadcrumb1">
                  <Breadcrumb.Item active className="breadcrumb-item1">
                    Home
                  </Breadcrumb.Item>
                  <Breadcrumb.Item className="breadcrumb-item1">
                    Library
            ...
            <Card.Body>
              <div>
                <Breadcrumb className="breadcrumb1 bg-info colorbreadcrumb">
                  <Breadcrumb.Item className="breadcrumb-item1" active>
                    <i className="fa fa-star-o me-2 text-white"></i>Home
                  </Breadcrumb.Item>
                </Breadcrumb>
                <Breadcrumb className="breadcrumb1 bg-success colorbreadcrumb">
                  ...
                  <Breadcrumb.Item className="breadcrumb-item1" active>
                    <i className="fa fa-star-o mx-2 text-white"></i>Library
                  </Breadcrumb.Item>
                </Breadcrumb>
                <Breadcrumb className="breadcrumb1 bg-secondary colorbreadcrumb">
                  <Breadcrumb.Item className="breadcrumb-item1 ">
                    <i className="fa fa-star-o text-white me-2 "></i>Home
                  </Breadcrumb.Item>
                  <Breadcrumb.Item className="breadcrumb-item1 ">
                    <i className="fa fa-star-o text-white mx-2 "></i>Library
                  </Breadcrumb.Item>
                  <Breadcrumb.Item className="breadcrumb-item1 ">
                    <i className="fa fa-star-o text-white mx-2 "></i>Data
                  </Breadcrumb.Item>
                </Breadcrumb>
              </div>
