          ...
          <Card>
            ...
            <Card.Body>
              <Nav className="nav1 br-7" activeKey="link-1">
                ...
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="link-4" className="disabled">
                    Disabled
                  </Nav.Link>
                </Nav.Item>
              </Nav>
          ...
          <Card>
            ...
            <Card.Body>
              <Nav className="nav1 flex-column br-7" activeKey="link-1">
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="link-1" active>
                    Active
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
            ...
            <Card.Body>
              <Nav className="nav-pills" activeKey="link-1">
                <Nav.Item className="m-2">
                  <Nav.Link eventKey="link-1" className="px-4 py-2" active>
                    Active
                  </Nav.Link>
                </Nav.Item>
                ...
                <Nav.Item className="m-2">
                  <Nav.Link eventKey="link-2" className="px-4 py-2">
                    Link
                  </Nav.Link>
                </Nav.Item>

                <Nav.Item className="m-2">
                  <Nav.Link eventKey="link-3" className="px-4 py-2 disabled">
                    Disabled
                  </Nav.Link>
                </Nav.Item>
              </Nav>
          ...
          <Card>
            ...
            <Card.Body>
              <Nav variant="pills" defaultActiveKey="home" className="navicon">
                <Nav.Item>
                  <Nav.Link className="border py-3 px-5 m-2" eventKey="home">
                    <i className="fe fe-home me-2"></i> Home
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link className="border py-3 px-5 m-2" eventKey="lock">
                    <i className="fe fe-unlock me-2"></i> Lock
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link
                    className="py-3 px-5 border show m-2"
                    eventKey="videos"
                  >
                    <i className="fe fe-play me-2"></i> Videos
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link className="border py-3 px-5 m-2" eventKey="servers">
                    <i className="fe fe-layers me-2"></i> Severs
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link className="border py-3 px-5 m-2" eventKey="gallery">
                    <i className="fe fe-image me-2"></i> Gallery
                  </Nav.Link>
                </Nav.Item>
              </Nav>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              >
                ...
                <Nav.Item>
                  <Nav.Link
                    className="border w-8 h-8 br-100 m-2"
                    eventKey="lock"
                  >
                    <span className="text-center mx-auto">
                ...
                <Nav.Item>
                  <Nav.Link
                    className="border show w-8 h-8 br-100 m-2"
                    eventKey="play"
                  >
                    <span className="text-center mx-auto">
...
`}
          ...
          <Card>
            ...
            <Card.Body>
              <Nav
                className="nav1 bg-primary br-7"
                defaultActiveKey="Primary-Active"
              >
                <Nav.Item className="nav-item1">
                  <Nav.Link
                    eventKey="Primary-Active"
                ...
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="Primary-Link-1" className="text-white">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="Primary-Link-2" className="text-white">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link
                    eventKey="Primary-Disable"
              ...
              <Nav
                className="nav1 bg-info mt-4 br-7"
                defaultActiveKey="Info-Active"
              >
                <Nav.Item className="nav-item1">
                  <Nav.Link
                    className="text-white active"
                    eventKey="Info-Active"
                  >
                    Active
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link className="text-white" eventKey="Info-Link-1">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link className="text-white" eventKey="Info-Link-2">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
              ...
              <Nav
                className="nav1 bg-success mt-4 br-7"
                defaultActiveKey="Success-Active"
              >
                <Nav.Item className="nav-item1">
                  <Nav.Link
                    className="text-white active"
                    eventKey="Success-Active"
                  >
                    Active
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="Success-Link-1" className="text-white">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="Success-Link-2" className="text-white">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link
                    eventKey="Success-Disable"
                    className="text-white-50"
                    disabled
                  >
                    Disabled
              ...
              <Nav
                className="nav1 bg-danger mt-4 br-7"
                defaultActiveKey="danger-Active"
              >
                <Nav.Item className="nav-item1">
                  <Nav.Link
                    eventKey="danger-Active"
                    className="text-white"
                    active
                  >
                    Active
                ...
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="danger-Link-1" className="text-white">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="danger-Link-2" className="text-white">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link
                    eventKey="danger-Disable"
                    className="text-white-50"
                    disabled
                  >
                    Disabled
              ...
              <Nav
                className="nav1 bg-secondary mt-4 br-7"
                defaultActiveKey="secondary-Active"
              >
                <Nav.Item className="nav-item1">
                  <Nav.Link
                    eventKey="secondary-Active"
                    className="text-white"
                    active
                  >
                    Active
                ...
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="secondary-Link-1" className="text-white">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="secondary-Link-2" className="text-white">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link
                    eventKey="secondary-Disable"
                    className="text-white-50"
                    disabled
                  >
                    Disabled
              ...
              <Nav
                className="nav1 bg-yellow mt-4 br-7"
                defaultActiveKey="yellow-Active"
              >
                <Nav.Item className="nav-item1">
                  <Nav.Link
                    eventKey="yellow-Active"
                    className="text-white"
                    active
                  >
                    Active
                ...
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="yellow-Link-1" className="text-white">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey="yellow-Link-2" className="text-white">
                    Link
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link
                    eventKey="yellow-Disable"
                    className="text-white-50"
                    disabled
                  >
                    Disabled
