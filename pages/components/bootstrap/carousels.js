      ...
      return (
          <div>
              <Slider {...settings}>
                          ...
                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/19.jpg"} data-bs-holder-rendered="true" />

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/20.jpg"} data-bs-holder-rendered="true" />

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/21.jpg"} data-bs-holder-rendered="true" />

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/22.jpg"} data-bs-holder-rendered="true" />

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/23.jpg"} data-bs-holder-rendered="true" />
        ...
        return (
            <div>
                <Slider {...settings}>
                            ...
                            <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/24.jpg"}/>

                            <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/25.jpg"}/>

                            <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/1.jpg"}/>

                            <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/2.jpg"}/>

                            <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/3.jpg"}/>
                </Slider>
            </div>
        );
    }
        ...
        return (
            <div>
                <Slider {...settings}>
                            ...
                            <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/4.jpg"}/>

                            <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/5.jpg"}/>

                            <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/6.jpg"}/>

                            <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/7.jpg"}/>

                            <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/8.jpg"}/>
      ...
      return (
          <div className="Top">
              <Slider {...settings}>
                          ...
                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/14.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/15.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/16.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/17.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/18.jpg"}/>
              </Slider>
          </div>
      );
  }
      ...
      return (
          <div className="Top-right">
              <Slider {...settings}>
                          ...
                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/19.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/20.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/21.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/22.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/23.jpg"}/>
              </Slider>
          </div>
      );
  }
      ...
      return (
          <div className="bottom-left">
              <Slider {...settings}>
                          ...
                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/9.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/10.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/11.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/12.jpg"}/>

                          <img className="d-block w-100 br-5" alt="" src={"../../../assets/images/media/13.jpg"}/>
              </Slider>
          </div>
      );
  }
            ...
            <Card.Body className="h-100">
              <Carousel>
                <Carousel.Item>
                  <img
                    className="d-block w-100 br-5 active"
                    src={"../../../assets/images/media/backgrounds/3.jpg"}
                    alt="First slide"
                  />
                  <Carousel.Caption>
                    <h3>Slide label</h3>
                ...
                <Carousel.Item>
                  <img
                    className="d-block w-100 br-5"
                    src={"../../../assets/images/media/backgrounds/1.jpg"}
                    alt="Second slide"
                  />
                ...
                <Carousel.Item>
                  <img
                    className="d-block w-100 br-5"
                    src={"../../../assets/images/media/backgrounds/2.jpg"}
                    alt="Third slide"
                  />
            ...
            <Card.Body className="h-100">
              <Carousel>
                <Carousel.Item>
                  <img
                    className="d-block w-100 br-5 active"
                    src={"../../../assets/images/media/backgrounds/4.jpg"}
                    alt="First slide"
                  />
                  <Carousel.Caption>
                    <h3>Slide label</h3>
                ...
                <Carousel.Item>
                  <img
                    className="d-block w-100 br-5"
                    src={"../../../assets/images/media/backgrounds/5.jpg"}
                    alt="Second slide"
                  />
                ...
                <Carousel.Item>
                  <img
                    className="d-block w-100 br-5"
                    src={"../../../assets/images/media/backgrounds/6.jpg"}
                    alt="Third slide"
                  />
