            ...
            <Card.Header className="d-sm-flex justify-content-between align-items-center d-block">
              ...
              <Form className="ms-auto">
                <Form.Check
                  ...
                  label="Show Code"
                  id="custom-switch"
                  onClick={() => setdefaultCode(!defaultCode)}
            ...
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check
                  ...
                  label="Show Code"
                  id="custom-switch"
                  onClick={() => setBootstrapCode(!bootstrapCode)}
                  className="showcode d-flex ms-auto mx-2"
                />
              </Form>
            </Card.Header>
            ...
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check
                  ...
                  label="Show Code"
                  id="custom-switch"
                  onClick={() => setClosedIconCode(!ClosedIconCode)}
                  className="showcode d-flex ms-auto mx-2"
                />
              </Form>
            </Card.Header>
              ...
              <Accordion defaultActiveKey="0" className="red">
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    ...
                    laborum. Fusce aliquet neque et accumsan fermentum. Aliquam
                    lobortis neque in nulla tempus, molestie fermentum purus
                    euismod.
                  </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="1">
            ...
            <Card.Header className="d-sm-flex justify-content-between align-items-center d-block">
              ...
              <Form className="ms-auto">
                <Form.Check
                  ...
                  label="Show Code"
                  id="custom-switch"
                  onClick={() => setStyled1Code(!Styled1Code)}
                  className="showcode d-flex ms-auto mx-2"
                />
              </Form>
            </Card.Header>
            ...
            <Card.Header className="d-sm-flex justify-content-between align-items-center d-block">
              ...
              <Form className="ms-auto">
                <Form.Check
                  ...
                  label="Show Code"
                  id="custom-switch"
                  onClick={() => setindivisual(!indivisual)}
                  className="showcode d-flex ms-auto mx-2"
                />
              </Form>
            </Card.Header>
                  ...
                  >
                    <Accordion.Item eventKey="0" className="acc_section ">
                      ...
                      <Accordion.Body>
                        ...
                        deserunt mollit anim id est laborum. Fusce aliquet neque
                        et accumsan fermentum. Aliquam lobortis neque in nulla
                        tempus, molestie fermentum purus euismod.
                      </Accordion.Body>
                    </Accordion.Item>
                  </Accordion>
                </div>
...
Accordians.layout = "Contentlayout";
