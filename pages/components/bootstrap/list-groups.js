        ...
        <Col sm={12} lg={6}>
          <Card>
            ...
            <Card.Body>
              <div className="">
                <ListGroup as="ul">
                  <ListGroupItem as="li" className="listunorder">
                    Cras justo odio
                  </ListGroupItem>
                  <ListGroupItem as="li" className="listunorder">
                    Dapibus ac facilisis in
        ...
        <Col sm={12} lg={6}>
          <Card>
            ...
            <Card.Body>
              <div className="">
                <ListGroup as="ul">
                  <ListGroupItem as="li" className="listorder1">
                    Cras justo odio
                  </ListGroupItem>
                  <ListGroupItem as="li" className="listorder1">
                    Dapibus ac facilisis in
        ...
        <Col sm={12} lg={6}>
          <Card>
            ...
            <Card.Body>
              <div className="">
                <ListGroup as="ul">
                  <ListGroupItem as="li" className="listunorder1">
                    Cras justo odio
                  </ListGroupItem>
                  <ListGroupItem as="li" className="listunorder1">
                    Dapibus ac facilisis in
          ...
          <Card>
            ...
            <Card.Body>
              <div className="">
                <ListGroup as="ol">
                  <ListGroup.Item as="li">
                    <i className="fa fa-check text-muted me-2"></i>Cras justo
                    odio
                  </ListGroup.Item>
                  <ListGroup.Item as="li">
                    <i className="fa fa-check text-muted me-2"></i>Dapibus ac
                    facilisis in
                  </ListGroup.Item>
                  <ListGroup.Item as="li">
                    <i className="fa fa-check text-muted me-2"></i>Morbi leo
                    risus
                  </ListGroup.Item>
                  <ListGroup.Item as="li">
                    <i className="fa fa-check text-muted me-2"></i>Porta ac
                    consectetur ac
                  </ListGroup.Item>
                  <ListGroup.Item as="li">
                    <i className="fa fa-check text-muted me-2"></i>Vestibulum at
                    eros
                  </ListGroup.Item>
                </ListGroup>
              </div>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="">
                <ListGroup as="ol">
                  <ListGroup.Item as="li">
                    <i className="fa fa-cog text-primary me-2"></i>Cras justo
                    odio
                  </ListGroup.Item>
                  <ListGroup.Item as="li">
                    <i className="fa fa-cog text-danger me-2"></i>Dapibus ac
                    facilisis in
                  </ListGroup.Item>
                  <ListGroup.Item as="li">
                    <i className="fa fa-cog text-success me-2"></i>Morbi leo
                    risus
                  </ListGroup.Item>
                  <ListGroup.Item as="li">
                    <i className="fa fa-cog text-warning me-2"></i>Porta ac
                    consectetur ac
                  </ListGroup.Item>
                  <ListGroup.Item as="li">
                    <i className="fa fa-cog text-info me-2"></i>Vestibulum at
                    eros
                  </ListGroup.Item>
                </ListGroup>
              </div>
            ...
            <Card.Body>
              <div className="">
                <ListGroup as="ol">
                  ...
                  >
                    Cras justo odio
                    <Badge bg="default" className="rounded-pill">
                      20
                    </Badge>
                  </ListGroup.Item>
                  <ListGroup.Item
        ...
        <Col lg={6}>
          <Card>
            ...
            <Card.Body className="px-5">
              ...
              <p>
                Lorem Ipsum, you need to as necessary All the Lorem Ipsum
                generators on the Internet tend to repeat Various versions have
