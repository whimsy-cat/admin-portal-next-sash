          ...
          <Card>
            ...
            <Card.Body>
              <p className="text-muted card-sub-title">
                Use the <code className="highlighter-rouge">.rounded-pill</code>{" "}
            ...
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check
                  ...
                  label="Show Code"
                  id="custom-switch"
                  onClick={() => setGradientpill(!Gradientpill)}
                  className="showcode d-flex ms-auto mx-2"
                />
              </Form>
            </Card.Header>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <div className="example">
                ...
                <Button variant="info" className="position-relative me-5 mb-3">
                  {" "}
                  Projects
                  <Badge
                    bg="danger"
                ...
                <Button variant="green" className="position-relative me-5 mb-3">
                  {" "}
                  Projects
                  <Badge
                    bg="danger"
