...
const TooltipPopover = () => {
  ...
  return (
    <div>
      <PageHeader
        titles="Tooltip and Popover"
        active="Tooltip and Popover"
      ...
      <Row>
        <Col lg={12}>
          ...
          <Card id="Tooltip">
            <Card.Header>
              <Card.Title>Default Tooltip</Card.Title>
            ...
            <Card.Body>
              <Form.Label className="mb-2">Static Example</Form.Label>
              ...
              {/* <!-- tooltip-static-demo --> */}
              <Form.Label className="mb-2">Example</Form.Label>
...
`}
          ...
          <Card id="Tooltip1">
            <Card.Header>
              <Card.Title>Color Tooltip</Card.Title>
              <Form className="ms-auto">
                <Form.Check
                  type="switch"
                  label="Show Code"
            ...
            <Card.Body>
              ...
              <div className="tooltip-static-demo mb-4 border br-3">
                <Row>
                  <Col sm={6} lg={3}>
                    <Tooltip className="tooltip-primary" placement="top">
                      Tooltip on the top
                    </Tooltip>
                  </Col>
                  <Col sm={6} lg={3} className="mg-t-30 mg-sm-t-0">
                    <Tooltip className="tooltip-secondary" placement="bottom">
                      Tooltip on the bottom
                    </Tooltip>
                  </Col>
                  <Col sm={6} lg={3} className="mg-t-30 mg-lg-t-0">
                    <Tooltip className="tooltip-danger" placement="left">
                      Tooltip on the left
                    </Tooltip>
                  </Col>
                  <Col sm={6} lg={3} className="mg-t-30 mg-lg-t-0">
                    <Tooltip className="tooltip-info" placement="right">
...
`}
          ...
          <Card>
            <Card.Header>
              <Card.Title>Default Popover</Card.Title>
              <Form className="ms-auto">
                <Form.Check
                  type="switch"
                  label="Show Code"
...
`}
          ...
          <Card>
            <Card.Header>
              <Card.Title>Colored Head Popover</Card.Title>
              <Form className="ms-auto">
                <Form.Check
                  type="switch"
                  label="Show Code"
                  id="custom-switch"
                  onClick={() => setColorHead(!ColorHead)}
                  className="showcode d-flex ms-auto mx-2"
                />
              </Form>
            </Card.Header>
...
`}
          ...
          <Card>
            <Card.Header>
              <Card.Title>Full Colored Popover</Card.Title>
              <Form className="ms-auto">
                <Form.Check
                  type="switch"
                  label="Show Code"
