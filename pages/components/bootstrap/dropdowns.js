            ...
            <Card.Body>
              <div className="text-wrap">
                <p>
                  ...
                  be turned into Link dropdown toggle with some markup
                  changes.The best part is you can do this with any button
                  variant, too
                </p>
            ...
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check
                  ...
                  label="Show Code"
                  id="custom-switch"
                  onClick={() => setSplitButon(!SplitButon)}
                  className="showcode d-flex ms-auto mx-2"
                />
              </Form>
            </Card.Header>
            ...
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check
                  ...
                  label="Show Code"
                  id="custom-switch"
                  onClick={() => setSplitDrop(!SplitDrop)}
                  className="showcode d-flex ms-auto mx-2"
                />
              </Form>
            </Card.Header>
            ...
            <Card.Body>
              <div className="text-wrap">
                <p>
                  ...
                  <code className="highlighter-rouge">.dropend</code> ,{" "}
                  <code className="highlighter-rouge">.dropstart</code> to the
                  parent element.
                </p>
                <div className="example">
                  ...
                  <Dropdown className="btn-group mt-2 mb-2 me-1">
                    ...
                    <Dropdown.Menu className="dropdown-menu p-4 text-muted">
                      <p>
                        ...
                        dropdown menu.And this is more example text.
                      </p>
                    </Dropdown.Menu>
                  </Dropdown>
                  <ButtonGroup className="mt-2 mb-2 me-1">
                      ...
                      <Form className="card-body w-260">
                        ...
                        <div className="text-center mt-3">
                          ...
                          <p className="text-dark mb-0">
                            {`Don't`} have account?
                            <Link className="text-primary.ms-1" href="#">
                              Register
                            </Link>
                          </p>
                        </div>
                      ...
                      <Dropdown.Header>
                        <h6>
                          ...
                          <span className="float-end">
                            yes<i className="fe fe-chevron-right"></i>
                          </span>
                        </h6>
                      </Dropdown.Header>
                      <Dropdown.Item href="#">
