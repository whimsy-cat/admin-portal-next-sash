              ...
              <div className="text-wrap">
                ...
                <div className="example">
                  <div className="btn-list">
                    ...
                    <Link href="#" className="btn btn-light btn-link">
                      Link
                    </Link>
                  </div>
                </div>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="text-wrap">
                ...
                <div className="example">
                  <div className="btn-list">
                    <Link href="#" className="btn btn-default disabled">
                      Default
                    </Link>
                    <Link href="#" className="btn btn-primary disabled">
                      Primary
                    </Link>
                    <Link href="#" className="btn btn-secondary disabled">
                      Secondary
                    </Link>
                    <Link href="#" className="btn btn-success disabled">
                      Success
                    </Link>
                    <Link href="#" className="btn btn-info disabled">
                      Info
                    </Link>
                    <Link href="#" className="btn btn-warning disabled">
                      Warning
                    </Link>
                    <Link href="#" className="btn btn-danger disabled">
                      Danger
                    </Link>
                    <Link href="#" className="btn btn-light btn-link disabled">
                      Link
                    </Link>
                  </div>
                </div>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="text-wrap">
                ...
                <div className="example">
                  <div className="btn-list">
                    <Link href="#" className="btn btn-default btn-pill">
                      Default
                    </Link>
                    ...
                    <Link href="#" className="btn btn-success btn-pill">
                      Success
                    </Link>
                    <Link href="#" className="btn btn-info btn-pill">
                      Info
                    </Link>
                    <Link href="#" className="btn btn-warning btn-pill">
                      Warning
                    </Link>
                    <Link href="#" className="btn btn-danger btn-pill">
                      Danger
                    </Link>
                  </div>
                </div>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="text-wrap">
                ...
                <div className="example">
                  <div className="btn-list">
                    <Link href="#" className="btn btn-outline-default">
                      Default
                    </Link>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="text-wrap">
                <p>
                  Use any of the available{" "}
                  <code className="highlighter-rouge">.btn-light-</code> classes
                  to quickly create a styled button.
                </p>
                <div className="example">
                  <div className="btn-list">
                    <Link href="#" className="btn btn-default-light">
                      Default
                    </Link>
                    ...
                    <Link href="#" className="btn btn-info-light ">
                      Info
                    </Link>
                    <Link href="#" className="btn btn-warning-light ">
                      Warning
                    </Link>
                ...
                <div className="example">
                  <div className="btn-list">
                    <Row cols={4}>
                      ...
                      <Col className="mb-2">
                        <Button className="mb-1 me-1" variant="secondary">
                          Default button
                        </Button>
                      ...
                      <Col className="mb-2">
                        <Button className="btn-lg mb-1 me-1" variant="success">
                          Large button
                        </Button>
                        <Button className="btn-lg mb-1" variant="success">
                          Large button
                        </Button>
                      </Col>
                    </Row>
              ...
              <div className="text-wrap">
                ...
                <div className="example">
                  <div className="d-grid gap-2">
                    <Button className="mb-1" variant="secondary-light">
                      Block button
                    </Button>
                    <Button className="mb-1" variant="danger-light">
                      Block button
                    </Button>
                  </div>
                </div>
            ...
            <Card.Body>
              <div className="text-wrap">
                <p>
                  ...
                  <code className="highlighter-rouge">&lt;a&gt;</code>classes to
          ...
          <Card>
            ...
            <Card.Body>
              <div className="text-wrap">
                <p>
                  Add{" "}
                  <code className="highlighter-rouge">{`data-bs-toggle="button"`}</code>{" "}
                  to toggle a button{" "}
              ...
              <div className="text-wrap">
                ...
                <div className="example">
                  <div className="btn-list">
                    ...
                    <Link href="#" className="btn btn-azure">
                      Azure
                    </Link>
                    ...
                    <Link href="#" className="btn btn-gray-dark">
                      Dark gray
                    </Link>
                  </div>
                </div>
            ...
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check
                  ...
                  label="Show Code"
                  id="custom-switch"
                  onClick={() => setSocialBtn(!SocialBtn)}
                  className="showcode d-flex ms-auto mx-2"
                />
              </Form>
            </Card.Header>
              ...
              <div className="text-wrap">
                ...
                <div className="example">
                  <div className="btn-list">
                    ...
                    <br />
                    <Button className="btn-loading btn-icon" variant="success">
                      <i className="fe fe-check"></i>
                    </Button>
                    <Button className="btn-loading btn-sm" variant="warning">
                      Button text
                    </Button>
                    <br />
                    <Button className="btn-loading btn-lg" variant="danger">
                      Button text
                    </Button>
                    <Button className="btn-loading d-grid" variant="info">
                      Button text
                    </Button>
                  </div>
                </div>
            ...
            <Card.Body>
              <div className="text-wrap">
                <p>
                  ...
                  <code className="highlighter-rouge">.btn-group</code> classes
                  to quickly create a styled button.
                </p>
                <div className="example">
                  <div
          ...
          <Card>
            <Card.Header>
              ...
              <Form className="ms-auto">
                <Form.Check
                  ...
                  label="Show Code"
                  id="custom-switch"
                  onClick={() => setOutBtnGrp(!OutBtnGrp)}
                  className="showcode d-flex ms-auto mx-2"
                />
              </Form>
            </Card.Header>
            <Card.Body>
              <div className="text-wrap">
                <p>
                  Use any of the available{" "}
                  <code className="highlighter-rouge">.btn .btn-outline-</code>{" "}
          ...
          <Card>
            ...
            <Card.Body>
              <div className="text-wrap">
                ...
                <div className="example">
                  <div className="btn-list">
                    <Button className="w-xs mb-1" variant="primary">
                      Min-XS
                    </Button>
                    <Button className="w-sm mb-1" variant="secondary">
                      Min-SM
                    </Button>
                    <Button className="w-md mb-1" variant="danger">
                      Min-MD
                    </Button>
                    <Button className="w-lg mb-1" variant="success">
                      Min-LG
                    </Button>
                  </div>
                </div>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="text-wrap">
                <p>
                  Use any of the available{" "}
                  <code className="highlighter-rouge">.btn-group-vertical</code>{" "}
                  classes to quickly create a styled button.
                </p>
                <div className="example">
