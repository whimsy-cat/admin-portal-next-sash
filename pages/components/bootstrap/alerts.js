...
import {
  ...
  AvatarList,
  IconDismissList,
} from "../../../shared/data/bootstrap/booststrapalertsdata";
              ...
              <Card.Footer className="text-center border-0 pt-0">
                <Row>
                  <div className="text-center">
                    <Link href="#" className="btn btn-white me-2">
                      cancel
                    </Link>
                    <Link href="#" className={`btn btn-${idx.color}`}>
                      {idx.buttonName}
                    </Link>
                  </div>
                </Row>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="text-wrap">
                <p>
                  Add{" "}
                  <code className="highlighter-rouge">{`className="alert alert-primary|secondary|success|info|warning|danger"`}</code>{" "}
            ...
            <Card.Body>
              <div className="text-wrap">
                <p>
                  ...
                  className to quickly provide matching colored links within any
                  alert
                </p>
                <div className="example">
                  <Form className="mb-3 d-flex ms-auto">
                    ...
                    <React.Fragment key={k}>
                      ...
                      >
                        <span>
                          <i
                            className="fe fe-x icon-dimiss"
                            onClick={() => handleAlertRemove1(item.id)}
                          ></i>
                        </span>
                        {item.icon}
                        {item.text}
                    ...
                    <React.Fragment key={k}>
                      <Alert variant={item.variant} className={item.classname}>
                        <span>
                          <i
                            className="fe fe-x icon-dimiss"
                            onClick={() => handleavatarRemove(item.id)}
                          ></i>
                        </span>
                        <img
                  ...
                  {AlertList.map((item, k) => (
                    <React.Fragment key={k}>
                      <Alert
                        ...
                        role="alert"
                      >
                        <span className="alert-inner--icon mx-2">
                          {item.icon}
                        </span>
                        <span className="alert-inner--text">
                          <strong>{item.show}</strong> This is a warning
                          alert—check it out that has an icon too!
                        </span>
                      </Alert>
                    </React.Fragment>
                  ))}
                    ...
                    <React.Fragment key={k}>
                      <Alert className={item.classname} variant={item.variant}>
                        <span>
                          <i
                            className="fe fe-x icon-dimiss"
                            onClick={() => handlesetIconRemove(item.id)}
                          ></i>
                        </span>
                        <span className="alert-inner--icon mx-2">
                          {item.icon}
                        ...
                        <span className="alert-inner--text">
                          <strong>{item.show}</strong> This is a default
                          alert—check it out!
                        </span>
                      </Alert>
                    </React.Fragment>
...
BootstrapAlerts.layout = "Contentlayout";
