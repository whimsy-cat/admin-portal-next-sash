...
const ModalS = () => {
 ...
 const show = () => {
  ...
  return (
      <div>
          <Link href="#" className="modal-effect btn btn-primary-light d-grid mb-3" onClick={show}>Zoom</Link>
            ...
            <Card.Body className="text-center">
              ...
              >
                ...
                <Modal.Body>
                  ...
                  <br /> <br /> But who has any right to find fault with a man
            ...
            <Card.Body>
              ...
              <Modal show={InsideShow} onHide={handleClose2}>
                <Modal.Header>
                  ...
                  <span className="ms-auto" onClick={handleClose2}>
                    <i className="fe fe-x ms-auto"></i>
                  </span>
                </Modal.Header>
                <Modal.Body>
...
`}
      ...
      <Row>
        <Col lg={12}>
          ...
          <Card id="modal">
            <Card.Header className="border-bottom-0 d-sm-flex d-block">
              <Card.Title className="mb-3 mb-sm-0">Basic Modal</Card.Title>
              <Form className="ms-auto">
                <Form.Check
                  type="switch"
                  label="Show Code"
          ...
          <Card id="modal3">
            ...
            <Card.Body>
              ...
              <div className="text-center py-4 bg-light border">
                ...
                >
                  <Modal.Header>
                    <span className="d-flex ms-auto" onClick={viewDemoClose2}>
                      <i className="fe fe-x ms-auto"></i>
                    </span>
                  </Modal.Header>
          ...
          <Card id="modal4">
            ...
            <Card.Body>
              ...
              <div className="text-center py-4 bg-light border">
                ...
                >
                  <Modal.Header>
                    <span className="d-flex ms-auto" onClick={viewDemoClose3}>
                      <i className="fe fe-x ms-auto"></i>
                    </span>
                  </Modal.Header>
                  <Modal.Body className="text-center p-4 pb-5">
