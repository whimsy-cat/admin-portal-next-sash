...
const AvatarRadius = () => {
  return (
    <div>
      <PageHeader
        titles="Avatar-Radius"
        active="Avatar-Radius"
        items={["Componets"]}
      />
      {/* <!-- ROW-1 OPEN --> */}
      <Row>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="text-wrap">
                <p>
                  Use classes<code className="highlighter-rouge">.avatar</code>{" "}
                  in <code className="highlighter-rouge">.bradius</code>.
                </p>
            ...
            <Card.Body>
              <div className="text-wrap">
                <div className="example">
                  ...
                  <div className="avatar-list">
                    <span className="avatar avatar-sm bradius bg-success">
                      A
                    </span>
                    <span className="avatar bradius bg-warning">B</span>
                    <span className="avatar avatar-md bradius bg-danger">
                      C
                    </span>
                    <span className="avatar avatar-lg bradius bg-info">D</span>
                    <span className="avatar avatar-xl bradius bg-secondary">
                      GE
                    </span>
                    <span className="avatar avatar-xxl bradius bg-primary">
                      A.N
                    </span>
                  </div>
                </div>
...
AvatarRadius.layout = "Contentlayout";
