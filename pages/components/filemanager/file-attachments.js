      ...
      <Row>
            ...
            <Card.Body>
              <div className="tags">
                ...
                >
                  ...
                  <Button
                    variant="primary"
                    className="btn-pill btn-close text-white"
                    aria-label="Close"
                  >
                    <span aria-hidden="true">×</span>
                  </Button>
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="secondary" className="btn-pill text-white">
                    <i className="mdi mdi-file-word me-2"></i> Word_file.doc
                  </Button>
                  <Button
                    variant="secondary"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="success" className="btn-pill text-white">
                    <i className="mdi mdi-file-excel me-2"></i> Excel_file.xls
                  </Button>
                  <Button
                    variant="success"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="warning" className="btn-pill text-white">
                    <i className="mdi mdi-file-pdf me-2"></i> pdf_file.pdf
                  </Button>
                  <Button
                    variant="warning"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="danger" className="btn-pill text-white">
                    <i className="mdi mdi-file-video me-2"></i> Video_file.mp4
                  </Button>
                  <Button
                    variant="danger"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="info" className="btn-pill text-white">
                    <i className="mdi mdi-file-music me-2"></i> Audio_file.mp3
                  </Button>
                  <Button
                    variant="info"
            ...
            <Card.Body>
              <div className="tags">
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="outline-secondary" className="btn-pill">
                    <i className="mdi mdi-file-word me-2"></i> Word_file.doc
                  </Button>
                  <Button
                    variant="outline-secondary"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="outline-success" className="btn-pill">
                    <i className="mdi mdi-file-excel me-2"></i> Excel_file.xls
                  </Button>
                  <Button
                    variant="outline-success"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="outline-warning" className="btn-pill">
                    <i className="mdi mdi-file-pdf me-2"></i> pdf_file.pdf
                  </Button>
                  <Button
                    variant="outline-warning"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="outline-danger" className="btn-pill">
                    <i className="mdi mdi-file-video me-2"></i> Video_file.mp4
                  </Button>
                  <Button
                    variant="outline-danger"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="outline-info" className="btn-pill">
                    <i className="mdi mdi-file-music me-2"></i> Audio_file.mp3
                  </Button>
                  <Button
                    variant="outline-info"
        ...
        <Col lg={6}>
          <Card className="custom-card">
            <Card.Header className="border-bottom">
              <Card.Title as="h3">
                Transparent Square File_Attachment
              </Card.Title>
            </Card.Header>
            <Card.Body>
              <div className="tags">
        ...
        <Col lg={6}>
          <Card className="custom-card">
            <Card.Header className="border-bottom">
              <Card.Title as="h3">
                Transparent Rounded File_Attachment
              </Card.Title>
            </Card.Header>
            <Card.Body>
              <div className="tags">
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="secondary-light" className=" btn-pill">
                    <i className="mdi mdi-file-word me-2"></i> Word_file.doc
                  </Button>
                  <Button
                    variant="secondary-light"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="success-light" className="btn-pill">
                    <i className="mdi mdi-file-excel me-2"></i> Excel_file.xls
                  </Button>
                  <Button
                    variant="success-light"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="warning-light" className="btn-pill">
                    <i className="mdi mdi-file-pdf me-2"></i> pdf_file.pdf
                  </Button>
                  <Button
                    variant="warning-light"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="danger-light" className="btn-pill">
                    <i className="mdi mdi-file-video me-2"></i> Video_file.mp4
                  </Button>
                  <Button
                    variant="danger-light"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="info-light" className="btn-pill">
                    <i className="mdi mdi-file-music me-2"></i> Audio_file.mp3
                  </Button>
                  <Button
                    variant="info-light"
            ...
            <Card.Body className="p-4 p-sm-5">
              ...
              <div className="tags">
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Link href="#" className="btn btn-pill btn-info text-white">
                    <i className="mdi mdi-file-image mx-2"></i>Image01..._jpg
                  </Link>
                  <Link
                    href="#"
                    className="btn btn-pill btn-close btn-info text-white"
                    aria-label="Close"
                  >
                    <span aria-hidden="true">×</span>
                  </Link>
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Link href="#" className="btn btn-pill btn-outline-warning">
                    <i className="mdi mdi-file-image me-2"></i> Image_file.jpg{" "}
                  </Link>
                  <Link
                    href="#"
                    className="btn btn-pill btn-close btn-outline-warning"
                    aria-label="Close"
                  >
                    <span aria-hidden="true">×</span>
                  </Link>
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Link href="#" className="btn btn-pill btn-danger-light">
                    <i className="mdi mdi-file-image me-2"></i> Image_file.jpg{" "}
                  </Link>
                  <Link
                    href="#"
                    className="btn btn-pill btn-close btn-danger-light"
                    aria-label="Close"
                  >
                    <span aria-hidden="true">×</span>
                  </Link>
            ...
            <Card.Body className="p-4 p-sm-5">
              <div className="tags">
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Button variant="pink" size="lg" className="btn-pill">
                    <i className="mdi mdi-file-pdf fs-20 me-2"></i>AMN0012.pdf
                  </Button>
                  <Button
                    variant="pink"
            ...
            <Card.Body className="p-4 p-sm-5">
              ...
              <div className="tags">
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Link href="#" className="btn btn-sm btn-primary text-white">
                    <i className="mdi mdi-file-image mx-2"></i>Image01..._jpg
                  </Link>
                  <Link
                    href="#"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Link href="#" className="btn btn-secondary text-white">
                    <i className="mdi mdi-file-excel me-2"></i>Document.exl
                  </Link>
                  <Link
                    href="#"
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Link href="#" className="btn btn-lg btn-pink">
                    <i className="mdi mdi-file-pdf fs-20 me-2"></i>AMN0012.pdf
                  </Link>
                  <Link
                    href="#"
                    className="btn btn-close btn-lg btn-pink"
                    aria-label="Close"
                  >
                    <span aria-hidden="true">×</span>
                  </Link>
            ...
            <Card.Body className="p-4 p-sm-5">
              ...
              <div className="tags">
                ...
                >
                  <Link
                    href="#"
                    className="btn btn-pill btn-sm btn-primary text-white"
                  >
                    <i className="mdi mdi-file-image me-2"></i>Image01..._jpg
                  </Link>
                  <Link
                    href="#"
                    className="btn btn-pill btn-close btn-sm btn-primary text-white"
                    aria-label="Close"
                  >
                    <span aria-hidden="true">×</span>
                  </Link>
                ...
                >
                  <Link
                    href="#"
                    className="btn btn-pill btn-secondary text-white"
                  >
                    <i className="mdi mdi-file-excel me-2"></i>Document.exl
                  </Link>
                  <Link
                    href="#"
                    className="btn btn-pill btn-close btn-secondary text-white"
                    aria-label="Close"
                  >
                    <span aria-hidden="true">×</span>
                  </Link>
                ...
                <ButtonGroup
                  ...
                  aria-label="Basic example"
                >
                  <Link href="#" className="btn btn-pill btn-lg btn-pink">
                    <i className="mdi mdi-file-pdf fs-20 me-2"></i>AMN0012.pdf
                  </Link>
                  <Link
                    href="#"
                    className="btn btn-pill btn-close btn-lg btn-pink"
                    aria-label="Close"
                  >
                    <span aria-hidden="true">×</span>
                  </Link>
                  ...
                  <Row>
                    <Col xl={2} lg={3} md={4} sm={4}>
                      <div className="file-image p-2">
                        <Link href={`/components/filemanager/file-details/`}>
                          <img
                        ...
                        <ul className="icons">
                          <li>
                            <Link href="#" className="btn bg-danger">
                              <i className="fe fe-trash"></i>
                            </Link>
                          </li>
                          <li>
                            <Link href="#" className="btn bg-secondary">
                              <i className="fe fe-download"></i>
                            </Link>
                          </li>
                          <li>
                            <Link
                              href={`/components/filemanager/file-details/`}
                    ...
                    <Col xl={2} lg={3} md={4} sm={4}>
                      <div className="file-image p-2">
                        <Link href={`/components/filemanager/file-details/`}>
                          <img
                            src={"../../../assets/images/media/files/11.jpg"}
                            alt="file-2"
                            className="w-100"
                          />
                        </Link>
                    ...
                    <Col xl={2} lg={3} md={4} sm={4}>
                      <div className="file-image p-2">
                        <Link href={`/components/filemanager/file-details/`}>
                          <img
                            src={"../../../assets/images/media/files/12.jpg"}
                            alt="file-3"
                            className="w-100"
                          />
                        </Link>
                    ...
                    <Col xl={2} lg={3} md={4} sm={4}>
                      <div className="file-image p-2">
                        <Link href={`/components/filemanager/file-details/`}>
                          <img
                            src={"../../../assets/images/media/files/13.jpg"}
                            alt="file-4"
                            className="w-100"
                          />
                        </Link>
                    ...
                    <Col xl={2} lg={3} md={4} sm={4}>
                      <div className="file-image p-2">
                        <Link href={`/components/filemanager/file-details/`}>
                          <img
                            src={"../../../assets/images/media/files/14.jpg"}
                            alt="file-5"
                            className="w-100"
                          />
                        </Link>
                    ...
                    <Col xl={2} lg={3} md={4} sm={4}>
                      <div className="file-image p-2">
                        <Link href={`/components/filemanager/file-details/`}>
                          <img
                            src={"../../../assets/images/media/files/10.jpg"}
                            alt="file-1"
                            className="w-100"
                          />
                        </Link>
            ...
            <Card.Body>
              <div className="text-wrap">
                ...
                <div className="file-image-1">
                  <Link href={`/components/filemanager/file-details/`}>
                    <img
                      src={"../../../assets/images/media/files/documents/1.png"}
                      alt="file-details"
                    />
                  </Link>
                  <ul className="icons">
                ...
                <div className="file-image-1">
                  <Link href={`/components/filemanager/file-details/`}>
                    <img
                      src={"../../../assets/images/media/files/documents/4.png"}
                      alt="file-2"
                    />
                  </Link>
                  <ul className="icons">
                ...
                <div className="file-image-1">
                  <Link href={`/components/filemanager/file-details/`}>
                    <img
                      src={"../../../assets/images/media/files/documents/3.png"}
                      alt="file-1"
                    />
                  </Link>
                  <ul className="icons">
                ...
                <div className="file-image-1">
                  <Link href={`/components/filemanager/file-details/`}>
                    <img
                      src={"../../../assets/images/media/files/documents/5.png"}
                      className="br-5"
                      alt="formart"
                    />
                  </Link>
