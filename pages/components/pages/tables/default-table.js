      ...
      <Row>
        <Col xl={6}>
          <Card>
            ...
            <Card.Body>
              <p>
                Use <code className="highlighter-rouge">.table-bordered</code>to
                add zebra-striping to any table row within the{" "}
                <code className="highlighter-rouge">.tbody</code>.
              </p>
              <div className="table-responsive">
      ...
      <Row>
        <Col xl={6}>
          <Card>
            ...
            <Card.Body>
              <p>
                Use <code className="highlighter-rouge">.table-borderless</code>
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                any <code className="highlighter-rouge">.table</code> more
                compact by cutting all cell{" "}
      ...
      <Row>
        ...
        <Col xl={6}>
          <Card>
            ...
            <Card.Body>
              <p>
                Use <code className="highlighter-rouge">.table-dark</code>to add
...
DefaultTable.layout = "Contentlayout";
