    ...
    <div>
      ...
      <Row>
        <Col xl={3}>
          <Card>
            <ListGroup
              className="list-group-transparent mb-0 mail-inbox pb-3"
              defaultActiveKey="#link"
            >
              <div className="mt-4 mb-4 mx-4 text-center">
                <Link
                  href={`/components/pages/mail-compose/`}
                  className="btn btn-primary btn-lg d-grid"
                >
                  Compose
                </Link>
              </div>
              <Link href={`/components/pages/mail-index/`} className="">
                <ListGroup.Item
                  eventKey="#link"
        ...
        <Col xl={9}>
          <Card>
                    ...
                    <div className="float-end d-none d-md-flex fs-15">
                      ...
                      >
                        <Button
                          as="a"
                          variant=""
                          className="text-success email-icon bg-success-transparent me-3"
                        >
                          <i className="fe fe-star text-success"></i>
                        </Button>
                      </OverlayTrigger>
                      <OverlayTrigger
                        placement="top"
                      ...
                      >
                        <Button
                          as="a"
                          variant=""
                          className="text-info email-icon bg-info-transparent me-3"
                        >
                          <i className="fa fa-reply text-info"></i>
                        </Button>
                      </OverlayTrigger>
                      <Dropdown className="me-3">
                        <Dropdown.Toggle
                          className="text-danger email-icon bg-danger-transparent no-caret"
                          as="a"
                        >
                        ...
                        <Dropdown.Menu className="dropdown-menu-end">
                          <Dropdown.Item href="#">
                            <i className="fe fe-share mx-2"></i> Reply
                          </Dropdown.Item>
                          <Dropdown.Item href="#">
                            <i className="fe fe-alert-circle mx-2"></i>Report
                            Spam
                          </Dropdown.Item>
                          <Dropdown.Item href="#">
                            <i className="fe fe-trash mx-2"></i>Delete
                          </Dropdown.Item>
                          <Dropdown.Item href="#">
                            <i className="fe fe-printer mx-2"></i>Print
                          </Dropdown.Item>
                          <Dropdown.Item href="#">
                            <i className="fe fe-filter mx-2"></i>Filter
                          </Dropdown.Item>
                        </Dropdown.Menu>
                      </Dropdown>
                    </div>
                    ...
                    <div className="border overflow-hidden p-0 br-7">
                      ...
                      <div className="p-3 text-center">
                        <Link
                          ...
                          className="fw-semibold fs-15 text-dark"
                        >
                          Image.jpg
                        </Link>
            ...
            <Card.Footer>
              <Link className="btn btn-primary mt-1 mb-1 me-2" href="#">
                <i className="fa fa-reply"></i> Reply
              </Link>
              <Link className="btn btn-secondary mt-1 mb-1 me-2" href="#">
