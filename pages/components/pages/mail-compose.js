...
const MailCompose = () => {
  return (
    <div>
      <PageHeader
        titles="Email-Compose"
        active="Email-Compose"
        items={["Pages"]}
      />
      {/* <!-- Row --> */}
      <Row>
          ...
          <Card>
            ...
            <Card.Footer className="d-sm-flex">
              <div className="mt-2 mb-2">
                ...
                >
                  <Button className="btn-svg me-1" variant="light">
                ...
                >
                  <Button className="btn-svg me-1" variant="light">
                    <span className="ri-image-line"></span>
                  </Button>
                </OverlayTrigger>
              ...
              <div className="btn-list ms-auto my-auto">
                <Button variant="danger" className="btn-space mb-0">
                  Cancel
                </Button>
                <Button variant="primary" className="btn-space mb-0">
                  Send message
                </Button>
              </div>
            </Card.Footer>
