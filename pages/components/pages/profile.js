                    ...
                    <Row>
                      <div className="panel profile-cover">
                        ...
                        <div className="btn-profile">
                          <Button variant="primary" className="mt-1 mb-1 me-2">
                            {" "}
                      ...
                      <div className="">
                        <div className="social social-profile-buttons mt-5 float-end">
                          <div className="mt-3">
                            <Loki
                              href="#"
                              className="social-icon text-primary me-2"
                            >
                ...
                <Card.Body>
                  <Form className="profile-edit">
                    ...
                    <div className="profile-share border-top-0">
                      <div className="mt-2">
                        {/* <Link href="#" className="me-2" title="Audio" data-bs-toggle="tooltip" data-bs-placement="top"><span className="text-muted"><i className="fe fe-mic"></i></span></Link>
                      <Link href="#" className="me-2" title="Video" data-bs-toggle="tooltip" data-bs-placement="top"><span className="text-muted"><i className="fe fe-video"></i></span></Link>
                      <Link href="#" className="me-2" title="Image" data-bs-toggle="tooltip" data-bs-placement="top"><span className="text-muted"><i className="fe fe-image"></i></span></Link> */}
                        <OverlayTrigger
                          placement="top"
              ...
              <Card className="border p-0 shadow-none">
                ...
                <Card.Footer className="user-pro-2">
                  <div className="media mt-0">
                    ...
                    <div className="media-body">
                      <h6 className="mb-0 mt-4 ms-2 me-2">
                        28 people like your photo
                      </h6>
                    </div>
                    <div className="ms-auto">
                      <div className="d-flex mt-1">
                        <Link className="new me-2 text-muted fs-16" href="#;">
                          <span className="">
                        ...
                        <Link className="new text-muted fs-16" href="#;">
                          <span className="">
                  ...
                  <div className="">
                    <div className="media overflow-visible">
                      ...
                      <div className="media-body valign-middle mt-2">
                        <Link href="#" className=" fw-semibold text-dark">
                          John Paige
                        </Link>
                    ...
                    <div className="media media-xs overflow-visible">
                      ...
                      <div className="">
                        <div className="social social-profile-buttons float-sm-end">
                          <Link className="social-icon bg-white" href="#">
                            <i className="fa fa-facebook"></i>
                          </Link>
                          <Link className="social-icon bg-white" href="#">
                            <i className="fa fa-twitter"></i>
