        ...
        <Col xl={3}>
          <Card>
            ...
            >
              ...
              <Link href="#">
                <ListGroup.Item className="d-flex align-items-center mx-4">
            ...
            <Card.Body className="p-6">
              <div className="inbox-body">
                <div className="mail-option">
                  ...
                  <ButtonGroup>
                    <Link href="#" className="btn mini tooltips p-1">
                      ...
                      <tbody>
                        {tableData.map((item) => (
                          <tr className={item.className} key={item.id}>
                            ...
                            <td className="inbox-small-cells">
                              <i className={`fa fa-star ${item.starClass}`}></i>
                            </td>
                            <td className="inbox-small-cells">
                              <i
                            ...
                            <td className="view-message dont-show fw-semibold clickable-row">
                              <Link
                                href={`/components/pages/mail-read/`}
                                className="text-dark"
                              >
                                {item.subject}
                              </Link>
