      ...
      <Row>
        <Col sm={6} xxl={3} md={6} lg={6}>
          <div className="panel price panel-color">
            ...
            <div className="panel-body p-0 ps-5">
              <p className="lead py-0 text-primary">
                <strong>$15 </strong>/ month
              </p>
              <p>
                <i className="fe fe-plus me-1 mx-1"></i>$1.9 per Listing
              </p>
            </div>
            <div className="panel-footer text-center px-5 border-0 pt-0">
              <Button variant="primary" className="btn-block btn-pill">
                Purchase Now!
              </Button>
            </div>
            <ListGroup variant="flush" className="pb-5">
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-circle-outline text-primary p-2 fs-12"></i>
        ...
        <Col sm={6} xxl={3} md={6} lg={6}>
          <div className="panel price panel-color">
            ...
            <div className="panel-body p-0 ps-5">
              <p className="lead py-0 text-secondary">
            ...
            <div className="panel-footer text-center px-5 border-0 pt-0">
              <Button variant="secondary" className="btn-block btn-pill">
                Purchase Now!
              </Button>
            </div>
            <ListGroup variant="flush" className="pb-5">
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-circle-outline text-secondary p-2 fs-12"></i>
                <strong> 3 Free</strong> Domain Name
              </ListGroup.Item>
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-circle-outline text-secondary p-2 fs-12"></i>
        ...
        <Col sm={6} xxl={3} md={6} lg={6}>
          <div className="panel price panel-color bg-success-transparent">
            ...
            <div className="panel-body p-0 ps-5">
              <p className="lead py-0 text-success">
            ...
            <div className="panel-footer text-center px-5 border-0 pt-0">
              <Button variant="success" className="btn-block btn-pill">
                Purchase Now!
              </Button>
            </div>
            <ListGroup variant="flush" className="pb-5">
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-circle-outline text-success p-2 fs-12"></i>
                <strong> 5 Free</strong> Domain Name
              </ListGroup.Item>
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-circle-outline text-success p-2 fs-12"></i>
                <strong>8 </strong> One-Click Apps
              </ListGroup.Item>
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-circle-outline text-success p-2 fs-12"></i>
                <strong> 2 </strong> Databases
        ...
        <Col sm={6} xxl={3} md={6} lg={6}>
          <div className="panel price panel-color">
            ...
            <div className="panel-body p-0 ps-5">
              <p className="lead py-0 text-danger">
                <strong>$35 </strong>/ month
              </p>
              <p>
                <i className="fe fe-plus me-1 mx-1"></i>$1.9 per Listing
              </p>
            ...
            <div className="panel-footer text-center px-5 border-0 pt-0">
              <Button variant="danger" className="btn-block btn-pill">
                Purchase Now!
              </Button>
            </div>
            <ListGroup variant="flush" className="pb-5">
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-circle-outline text-danger p-2 fs-12"></i>
                <strong> 4 Free</strong> Domain Name
              </ListGroup.Item>
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-circle-outline text-danger p-2 fs-12"></i>
                <strong>6 </strong> One-Click Apps
              </ListGroup.Item>
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-circle-outline text-danger p-2 fs-12"></i>
                <strong> 2 </strong> Databases
      ...
      <Row>
        ...
        <Col sm={6} xxl={3} md={6} lg={6}>
          <div className="panel price panel-color">
            ...
            <ListGroup variant="flush" className="pb-5">
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-checkbox-marked-circle-outline text-secondary p-2 fs-16"></i>
                <strong> 3 Free</strong> Domain Name
              </ListGroup.Item>
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-checkbox-marked-circle-outline text-secondary p-2 fs-16"></i>
        ...
        <Col sm={6} xxl={3} md={6} lg={6}>
          <div className="panel price panel-color">
            ...
            <ListGroup variant="flush" className="pb-5">
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-checkbox-marked-circle-outline text-success p-2 fs-16"></i>
                <strong> 5 Free</strong> Domain Name
              </ListGroup.Item>
              <ListGroup.Item className="border-0">
                <i className="mdi mdi-checkbox-marked-circle-outline text-success p-2 fs-16"></i>
          ...
          <Card>
            <div className="princing-item">
              ...
              <div className=" br-be-0 br-bs-0 bg-white mt-0 shadow">
                <ListGroup variant="flush">
                  <ListGroup.Item>
                    <i className="fe fe-check text-danger p-2 fw-bold"></i>
                    <b>10</b> users included for this pack
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <i className="fe fe-check text-danger p-2 fw-bold"></i>
                ...
                <Card.Footer className="text-center p-5">
                  <Button variant="danger" className="btn btn-danger btn-block">
                    Sign Up Now
                  </Button>
                </Card.Footer>
              </div>
          ...
          <Card>
            <div className="princing-item">
              ...
              <div className="br-be-0 br-bs-0 bg-white mt-0 shadow">
                <ListGroup variant="flush">
                  <ListGroup.Item>
                    <i className="fe fe-check text-success p-2 fw-bold"></i>
                    <b>10</b> users included for this pack
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <i className="fe fe-check text-success p-2 fw-bold"></i>
                    ...
                    <Card className="p-3 pricing-card">
                      <Card.Header className="card-header d-block text-justified pt-2">
                        ...
                        <p className="text-justify fw-semibold mb-1">
                          ...
                          <span className="fs-25">
                            <span className="op-0-5 text-muted text-20">/</span>{" "}
                            month
                          </span>
                        </p>
                      ...
                      <Card.Body className="pt-2">
                        <ul className="text-justify pricing-body ps-0">
                          ...
                          <li className="text-muted">
                            <i className="mdi mdi-close-circle-outline p-2 fs-16 text-gray"></i>
                            <strong> Unlimited </strong> Cloud Storage
                          </li>
                          <li className="text-muted">
                            <i className="mdi mdi-close-circle-outline p-2 fs-16 text-gray"></i>
                            <strong> Money </strong> BackGuarantee
                  ...
                  <Col sm={6} xxl={3} md={6} lg={6}>
                    <Card className="p-3 pricing-card">
                      <Card.Header className="card-header d-block text-justified pt-2">
                        ...
                        <p className="fs-13 mb-1  text-success">
                          Billed monthly on regular basis!
                        </p>
                      </Card.Header>
                      <Card.Body className="pt-2">
                        <ul className="text-justify pricing-body ps-0">
                          ...
                          <li className="text-muted">
                            <i className="mdi mdi-close-circle-outline text-success p-2 fs-16"></i>
                            <strong> Unlimited </strong> Cloud Storage
                          </li>
                          <li className="text-muted">
                            <i className="mdi mdi-close-circle-outline text-gray p-2 fs-16"></i>
