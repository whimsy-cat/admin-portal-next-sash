          ...
          <Card>
            ...
            <Card.Body>
              <Form>
                ...
                <Button variant="primary" className="mt-4 mb-0">
                  Submit
                </Button>
              </Form>
            </Card.Body>
          ...
          <Card>
            ...
            <Card.Body>
              <Form className="form-horizontal">
                <Row className="mb-4">
                  <Form.Label htmlFor="inputName" className="col-md-3">
                    User Name
                  </Form.Label>
                  <Col md={9}>
                    <Form.Control
                ...
                <Row className="mb-4">
                  <Form.Label htmlFor="inputEmail3" className="col-md-3">
                    Email
                  </Form.Label>
                  <Col md={9}>
                    <Form.Control
                ...
                <Row className="mb-4">
                  <Form.Label htmlFor="inputPassword3" className="col-md-3">
                    Password
                  </Form.Label>
                  <Col md={9}>
                    <Form.Control
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                your <code className="highlighter-rouge">&lt;label&gt;</code> s
                or <code className="highlighter-rouge">&lt;legend&gt;</code>s to
              ...
              <Row className="mb-0">
                <Form.Label htmlFor="colFormLabelSm" className="col-sm-2">
                  Email
                </Form.Label>
                <Col sm={10}>
                  <Form.Control
              ...
              <Row>
                <Form.Label
                  ...
                  className="col-sm-2 col-form-label-lg"
                >
                  Email
                </Form.Label>
                <Col sm={10}>
                          ...
                          <Form.Group>
                            <Form.Label>
                              ...
                              <OverlayTrigger
                                ...
                                overlay={
                                  <Tooltip>
                                    CVV is the last three digits on the back of
                                    your credit card
                                  </Tooltip>
                                }
                              >
