          ...
          <Card>
            ...
            <Card.Body className="pb-2">
              <p>
                ...
                <code className="highlighter-rouge">&lt;textarea&gt;</code> s an
                upgrade with custom styles,focus states, and more.
              </p>
            ...
            <Card.Body className="">
              ...
              <Row className="row-sm">
                <div className="col-lg">
                  ...
                  <Form.Control
                    className=" mb-4"
                    placeholder=" Default from-control"
                    type="text"
                  />
                  <Form.Control
              ...
              <Form className="needs-validation was-validated">
                <Row className="row-sm">
                  <Col lg={6}>
                    <Form.Group>
                      <Form.Control
                        className="mb-4 is-valid state-valid"
          ...
          <Card>
            ...
            <Card.Body className="">
              <p>
                ...
                className to remove the default form field styling and preserve
            ...
            <Card.Body className="">
              ...
              <Form.Group className="m-0 mt-3">
                <Form.Label className="mb-5">
                  React-Bootstrap Toggle Custom switches
                </Form.Label>
                <Row>
            ...
            <Card.Body className="">
              ...
              <Form.Group>
                <InputGroup className="my-3">
                  ...
                  <InputGroup.Text className="input-group-text br-0">
                    @
                  </InputGroup.Text>
                  ...
                  <Form.Group className="mb-3">
                    <label className="custom-switch form-switch mb-0">
                      <input
                        ...
                        className="custom-switch-input"
                      />
                      <span className="custom-switch-indicator custom-switch-indicator"></span>
                      <span className="custom-switch-description">
                        Toggle example
                      </span>
                    </label>
