...
const FormInputSpinners = () => {
  return (
    <div>
      <PageHeader
        titles="Form-Input-Spinners"
        active="Form-Input-Spinners"
        items={["Forms"]}
      />
        ...
        <Col xl={6}>
          ...
          <Card>
            ...
            <div className="card-body">
              ...
              <div className="form-group">
                <Form.Label forhtml="input-label-sm-is-valid">
          ...
          <Card>
            ...
            <div className="card-body">
              ...
              <div className="form-group">
                <Form.Label forhtml="input-label-lg-is-valid">
          ...
          <Card>
            ...
            <Card.Body className="pb-3">
              ...
              <h6 className="my-5 fw-semibold fs-15" id="form-control-lg-sm">
                Small spinners
              </h6>
              ...
              <h6 className="my-5 fw-semibold fs-15" id="form-control-lg-lg">
                Large Spinners
              </h6>
          ...
          <Card>
            ...
            <Card.Body className="pb-3">
              ...
              <div className="mb-3 is-loading">
                <Form.Control
                  className="form-control-plaintext is-valid"
              ...
              <h6
                className="my-5 fw-semibold fs-15"
          ...
          <Card>
            ...
            <Card.Body className="pb-3">
              ...
              <h5 className="my-5 fw-semibold fs-15">
              ...
              <h6 className="my-5 fw-semibold fs-15" id="input-group-append-lg">
...
FormInputSpinners.layout = "Contentlayout";
